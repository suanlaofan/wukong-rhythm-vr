...
namespace ByteDance.PICO.XR
{
    public static class PXR_Usages
    {
        ...
        public static InputFeatureUsage<bool> gazeStatus = new InputFeatureUsage<bool>("isEyeGazeTracked");
        public static InputFeatureUsage<uint> gazeTrackingState = new InputFeatureUsage<uint>("eyeGazeTrackingState");
        public static InputFeatureUsage<Vector3> gazePosition = new InputFeatureUsage<Vector3>("eyeGazePosition");
        public static InputFeatureUsage<Quaternion> gazeRotation = new InputFeatureUsage<Quaternion>("eyeGazeRotation");
