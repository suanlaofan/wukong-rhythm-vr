...
namespace ByteDance.PICO.XR
{
    ...
    public class PXR_SpatialMeshManager : MonoBehaviour
    {
...
#if PICO_MS_SDK
            StartCoroutine(InitializeMeshSubsystemAfterDelay());
#elif PICO_XR_SDK   
...
#if PICO_MS_SDK
        private IEnumerator InitializeMeshSubsystemAfterDelay()
        {
        ...
        {
            Debug.Log("AddOrUpdateMesh CreateMeshRoutine ."); 
...
#if PICO_MS_SDK
            Debug.Log("AddOrUpdateMesh SyncMesh ."); 
