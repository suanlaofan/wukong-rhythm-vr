...
namespace ByteDance.PICO.OpenXR
{
    ...
    public class OpenXRExtensions : OpenXRFeature
    {
        ...
        public bool ApplyFlipYToAndroidSurface = false;
...
#if XR_COMPOSITION_LAYERS && UNITY_OPENXR_1_16_0
            var layerHandler = new PicoOpenXRCompositionLayer();
            OpenXRLayerProvider.RegisterLayerHandler(typeof(PicoLayerData), layerHandler);
#endif
             PICO_setFlipYToAndroidSurface(ApplyFlipYToAndroidSurface);
        }
        ...
        [DllImport(PXR_Plugin.PXR_PLATFORM_DLL, CallingConvention = CallingConvention.Cdecl)]
        private static extern void PICO_setFlipYToAndroidSurface(bool value);
