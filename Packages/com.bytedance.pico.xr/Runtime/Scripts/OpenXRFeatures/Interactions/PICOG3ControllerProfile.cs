...
namespace ByteDance.PICO.OpenXR.Interactions
{
    /// <summary>
    ...
    public class PICOG3ControllerProfile : OpenXRInteractionFeature
    {
        ...
        {
            InputSystem.RegisterLayout(typeof(PICOG3TouchController),
        ...
        {
            InputSystem.RemoveLayout(nameof(PICOG3TouchController));
        }
