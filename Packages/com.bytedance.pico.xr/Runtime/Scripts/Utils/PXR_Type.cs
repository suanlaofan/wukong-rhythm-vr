...
namespace ByteDance.PICO.XR
{
    ...
    public unsafe struct MotionTrackerLocation
    {
        ...
        public override string ToString()
        {
            ...
            str += string.Format(" locationFlags:{0}", locationFlags);
            return str;
        }
    }
    ...
    /// <summary>Information about the battery of the external device.</summary>
    [StructLayout(LayoutKind.Sequential)]
    ...
    public struct Posef
    {
        ...
        public static Posef Identity = new Posef(Vector3.zero, Quaternion.identity);
        public Posef(Vector3 position, Quaternion rotation)
        {
            Position = new Vector3f() { x = position.x, y = position.y, z = position.z };
            Orientation = new Quatf() { x = rotation.x, y = rotation.y, z = rotation.z, w = rotation.w };
        }
    }
    ...
    /// <summary>
    /// Bit flags for XrSpaceLocationFlags
    /// </summary>
    public static class XrSpaceLocationFlags
    {
        /// <summary>Orientation data valid bit</summary>
        public const ulong XR_SPACE_LOCATION_ORIENTATION_VALID_BIT = 0x00000001;
        /// <summary>Position data valid bit</summary>
        public const ulong XR_SPACE_LOCATION_POSITION_VALID_BIT = 0x00000002;
        /// <summary>Orientation is being tracked bit</summary>
        public const ulong XR_SPACE_LOCATION_ORIENTATION_TRACKED_BIT = 0x00000004;
        /// <summary>Position is being tracked bit</summary>
    ...
    public struct HandJointLocations
    {
        ...
        /// <summary>
        /// The number of hand joints that the SDK supports. Currently returns `26`.
        /// </summary>
    ...
    public partial class PXR_Input
    {
        ...
        /// <summary>The controller types.</summary>
...
#endif
    public enum PICOTrackingState
    {
        //< The default state.
        NONE = 0,

        //< The tracking provider is initialized.
        INITIALIZED = 1,

        //< The tracking provider is running.
        RUNNING = 2,

        //< The tracking provider is paused.
        PAUSED = 3,

        //< The tracking provider is stopped.
        STOPPED = 4,

        //< The tracking provider is invalid.
        INVALID = 5
    }

    public enum PICOTrackingSupportState
    {
        //< The default value
        NONE = 0,

        //< The tracking provider is supported.
        SUPPORTED = 1,

        //< The tracking provider is not supported by device.
        DEVICE_NOT_SUPPORTED = 2,

        //< The tracking provider is not in fullspace.
        NOT_IN_FULLSPACE = 3,

        //< The tracking provider not access permission.
        WITHOUT_PERMISSION = 4,
    }
}