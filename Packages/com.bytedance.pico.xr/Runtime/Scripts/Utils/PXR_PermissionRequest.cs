...
namespace ByteDance.PICO.XR
{
    public class PXR_PermissionRequest : MonoBehaviour
    {
        ...
        public static void RequestUserPermissionMR(Action<string> _PermissionDenied = null, Action<string> _PermissionGranted = null,
            Action<string> _PermissionDeniedAndDontAskAgain = null)
        {
