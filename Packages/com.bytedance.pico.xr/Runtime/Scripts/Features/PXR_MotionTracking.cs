...
namespace ByteDance.PICO.XR
{
    public class PXR_MotionTracking
    {
        ...
        /// <summary>
        /// Gets the confidence of the location data.
        /// </summary>
        /// <param name="locationFlags">Specifies the location flags.</param>
        /// <returns>The confidence of the location data.</returns>
        public static MotionTrackerConfidence GetMotionTrackerMotionTrackerConfidence(ulong locationFlags)
        {
            if ((locationFlags == (XrSpaceLocationFlags.XR_SPACE_LOCATION_POSITION_VALID_BIT | XrSpaceLocationFlags.XR_SPACE_LOCATION_POSITION_TRACKED_BIT | XrSpaceLocationFlags.XR_SPACE_LOCATION_ORIENTATION_VALID_BIT | XrSpaceLocationFlags.XR_SPACE_LOCATION_ORIENTATION_TRACKED_BIT)))
            {
                Debug.Log("GetLocateMotionTracker PXR_6DOF_ACCURATE");
                return MotionTrackerConfidence.PXR_6DOF_ACCURATE;
            }
            else if ((locationFlags == (XrSpaceLocationFlags.XR_SPACE_LOCATION_ORIENTATION_VALID_BIT | XrSpaceLocationFlags.XR_SPACE_LOCATION_ORIENTATION_TRACKED_BIT)))
            {
                Debug.Log("GetLocateMotionTracker PXR_3DOF_NOT_ACCURATE");
                return MotionTrackerConfidence.PXR_3DOF_NOT_ACCURATE;
            }
            if ((locationFlags == (XrSpaceLocationFlags.XR_SPACE_LOCATION_POSITION_VALID_BIT | XrSpaceLocationFlags.XR_SPACE_LOCATION_ORIENTATION_VALID_BIT | XrSpaceLocationFlags.XR_SPACE_LOCATION_ORIENTATION_TRACKED_BIT)))
            {
                Debug.Log("GetLocateMotionTracker PXR_6DOF_NOT_ACCURATE");
                return MotionTrackerConfidence.PXR_6DOF_NOT_ACCURATE;
            }
            else
            {
                Debug.Log("GetLocateMotionTracker NONE");
                return MotionTrackerConfidence.NONE;
            }
        }
