...
namespace ByteDance.PICO.XR
{
    public class PXR_ARCameraEffectManager : MonoBehaviour
    {
        ...
        [HideInInspector] public float colortempValue;
        ...
        [HideInInspector] public Texture2D lutTex1;
        [HideInInspector] public Texture2D lutTex2;
        [HideInInspector] public Texture2D lutTex3;
        [HideInInspector] public Texture2D lutTex4;
        [HideInInspector] public Texture2D lutTex5;
