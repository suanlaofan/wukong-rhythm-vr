...
namespace ByteDance.PICO.XR.Input
{
    /// <summary>
    /// A PICO Headset
    /// </summary>
    ...
    public class PXR_HMD : XRHMD
    {
        ...
        [Preserve]
        [InputControl]
        public new ButtonControl eyeGazeIsTracked { get; private set; }
        [Preserve]
        [InputControl]
        public new IntegerControl eyeGazeTrackingState { get; private set; }
        [Preserve]
        [InputControl]
        public new Vector3Control eyeGazePosition { get; private set; }
        [Preserve]
        [InputControl]
        public new QuaternionControl eyeGazeRotation { get; private set; }
        ...
        protected override void FinishSetup()
        {
            ...
            eyeGazeIsTracked = GetChildControl<ButtonControl>("isEyeGazeTracked");
            eyeGazeTrackingState = GetChildControl<IntegerControl>("eyeGazeTrackingState");
            eyeGazePosition = GetChildControl<Vector3Control>("eyeGazePosition");
            eyeGazeRotation = GetChildControl<QuaternionControl>("eyeGazeRotation");
        }
    }
    ...
    public class PXR_Controller : XRControllerWithRumble
    {
        ...
        public Vector3Control deviceAngularAcceleration { get; private set; }
        [Preserve]
        [InputControl(aliases = new[] { "gripSurfacePosition" })]
        public new Vector3Control gripSurfacePosition { get; private set; }
        [Preserve]
        [InputControl(aliases = new[] { "gripSurfaceRotation" })]
        public new QuaternionControl gripSurfaceRotation { get; private set; }
        protected override void FinishSetup()
        {
            base.FinishSetup();
            ...
            gripSurfacePosition = GetChildControl<Vector3Control>("gripSurfacePosition");
            gripSurfaceRotation = GetChildControl<QuaternionControl>("gripSurfaceRotation");
