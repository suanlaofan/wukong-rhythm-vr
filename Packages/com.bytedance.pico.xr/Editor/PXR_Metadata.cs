...
namespace ByteDance.PICO.XR.Editor
{
    internal class PXR_Metadata : IXRPackage
    {
        private class PXR_PackageMetadata : IXRPackageMetadata
        {
            ...
            public string packageId => "com.bytedance.pico.xr";

            public string settingsType => "ByteDance.PICO.XR.PXR_Settings";
        ...
        private class PXR_LoaderMetadata : IXRLoaderMetadata
        {
            ...
            public string loaderType => "ByteDance.PICO.XR.PXR_Loader";
