...
namespace ByteDance.PICO.XR.Editor
{
    public class PXR_AppLog
    {
        ...
        public static string strBuildingBlocks_PICOGazeInteractor = "pico_eye_gaze_interactor";
        public static string strBuildingBlocks_PICOInteractionUtilities = "pico_interaction_utilities";
        public static string strBuildingBlocks_PICOCameraPack = "pico_camera_pack";
        #endregion
