...
#region Cross-Platform Validation (PXR & OpenXR)
            ...
            new BuildValidationRule
                ...
                new BuildValidationRule
                {
                    ...
                    FixIt = () =>
                    {
                        string url = "https://developer.picoxr.com/document/unity/number-of-apks-associated-with-a-key-exceeds-limit/";
                        Application.OpenURL(url);
                ...
                {
                    Category = k_Catergory,
                    Message = $"The range of official Unity versions supported by PICO SDK is from {PXR_Utils.minUnityVersion} to Unity 6. ",
                    IsRuleEnabled = ()=>
                    {
                        return PXR_Utils.IsPXRValidationEnabled() || PXR_Utils.IsOpenXRValidationEnabled();
                    },
                    ...
                    FixItMessage = "You can Use Unity {PXR_Utils.minUnityVersion} - Unity 6. ",
                    FixIt = () =>
                    {
