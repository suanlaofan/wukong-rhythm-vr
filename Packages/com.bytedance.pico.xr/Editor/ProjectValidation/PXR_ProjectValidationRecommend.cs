...
namespace ByteDance.PICO.XR.Editor
{
        ...
        const BuildTargetGroup recommendedBuildTarget = BuildTargetGroup.Android;
            ...
            var androidGlobalRules = new[]
            {
                ...
                new BuildValidationRule
                {
                    ...
                    IsRuleEnabled = () => { return PXR_Utils.IsPXRValidationEnabled() || PXR_Utils.IsOpenXRValidationEnabled(); },
                    CheckPredicate = () => { return PlayerSettings.Android.targetSdkVersion == AndroidSdkVersions.AndroidApiLevelAuto; },
                ...
                new BuildValidationRule
                {
                    ...
                    IsRuleEnabled = () => { return PXR_Utils.IsPXRValidationEnabled() || PXR_Utils.IsOpenXRValidationEnabled(); },
                    CheckPredicate = () => { return PlayerSettings.Android.preferredInstallLocation == AndroidPreferredInstallLocation.Auto; },
                ...
                new BuildValidationRule
                {
                    ...
                    IsRuleEnabled = () => { return PXR_Utils.IsPXRValidationEnabled() || PXR_Utils.IsOpenXRValidationEnabled(); },
                    CheckPredicate = () => { return !PlayerSettings.graphicsJobs; },
                ...
                new BuildValidationRule
                {
                    ...
                    IsRuleEnabled = () => { return PXR_Utils.IsPXRValidationEnabled() || PXR_Utils.IsOpenXRValidationEnabled(); },
                    CheckPredicate = () => { return PlayerSettings.use32BitDisplayBuffer; },
                ...
                new BuildValidationRule
                {
                    ...
                    IsRuleEnabled = () => { return PXR_Utils.IsPXRValidationEnabled() || PXR_Utils.IsOpenXRValidationEnabled(); },
                    CheckPredicate = () => { return PlayerSettings.GetMobileMTRendering(recommendedBuildTarget); },
                ...
                new BuildValidationRule
                {
                    ...
                    IsRuleEnabled = () => { return PXR_Utils.IsPXRValidationEnabled() || PXR_Utils.IsOpenXRValidationEnabled(); },
                    CheckPredicate = () => { return QualitySettings.globalTextureMipmapLimit == 0; },
                ...
                new BuildValidationRule
                {
                    ...
                    IsRuleEnabled = () => { return PXR_Utils.IsPXRValidationEnabled() || PXR_Utils.IsOpenXRValidationEnabled(); },
                    CheckPredicate = () => { return QualitySettings.anisotropicFiltering == AnisotropicFiltering.Enable; },
                ...
                new BuildValidationRule
                {
                    ...
                    IsRuleEnabled = () => { return PXR_Utils.IsPXRValidationEnabled() || PXR_Utils.IsOpenXRValidationEnabled(); },
                    CheckPredicate = () => { return GetSettings().stereoRenderingModeAndroid == PXR_Settings.StereoRenderingModeAndroid.Multiview; },
                ...
                new BuildValidationRule
                {
                    ...
                    IsRuleEnabled = () => { return PXR_Utils.IsPXRValidationEnabled() || PXR_Utils.IsOpenXRValidationEnabled(); },
                    CheckPredicate = () => { return Physics.defaultContactOffset >= 0.01f; },
                ...
                new BuildValidationRule
                {
                    ...
                    IsRuleEnabled = () => { return PXR_Utils.IsPXRValidationEnabled() || PXR_Utils.IsOpenXRValidationEnabled(); },
                    CheckPredicate = () => { return Physics.sleepThreshold >= 0.005f; },
                ...
                new BuildValidationRule
                {
                    ...
                    IsRuleEnabled = () => { return PXR_Utils.IsPXRValidationEnabled() || PXR_Utils.IsOpenXRValidationEnabled(); },
                    CheckPredicate = () => { return Physics.defaultSolverIterations <= 8; },
 ...
 (UniversalRendererData)AssetDatabase.LoadAssetAtPath(dependency[i], typeof(UniversalRendererData));
            ...
            new BuildValidationRule
                {
                    ...
                    FixItMessage =
 "Open Project Settings > Player Settings > Player > Resolution and Presentation > Resolution > 'Run Without Focus' set to enable.",
                    FixIt = () =>
                    {
                ...
                new BuildValidationRule
                {
                    ...
                    CheckPredicate = () => { return PXR_ProjectSetting.GetProjectConfig().openMRC; },
                ...
                new BuildValidationRule
                {
                    ...
                    IsRuleEnabled = PXR_Utils.IsPXRValidationEnabled,
                    CheckPredicate = () => { return GetSettings().systemDisplayFrequency == PXR_Settings.SystemDisplayFrequency.Default; },
                ...
                new BuildValidationRule
                {
                    ...
                    IsRuleEnabled = PXR_Utils.IsPXRValidationEnabled,
                    CheckPredicate = () => { return PlayerSettings.colorSpace == ColorSpace.Linear; },
                ...
                new BuildValidationRule
                {
                    ...
                    IsRuleEnabled = PXR_Utils.IsPXRValidationEnabled,
                    CheckPredicate = () => { return !(PXR_ProjectSetting.GetProjectConfig().useContentProtect && GetSettings().enableAppSpaceWarp); },
