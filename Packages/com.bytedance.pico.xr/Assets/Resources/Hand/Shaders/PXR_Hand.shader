Shader "PXR/Hand"
{
    Properties
    {
        ...
        _OutColor("Outer Color",Color) = (1,1,1,1)
        _FresnelPower("Fresnel Power",float) = 1

        [Header(Light)][Space(5)]
        _PressLight("Press Light",Color) = (1,1,1,1)
        _ClickLight("Click Light",Color) = (1,1,1,1)
        _PressRange("Press Range",Range(0,1)) = 0.015
        _ClickRange("Click Range",Range(0,1)) = 0.015
        _ClickPosition("Click Position",Vector)=(1,1,1,1)
        _PressIntensity("Press Intensity",Range(0,1)) = 1

        [Header(Wrist)][Space(10)]
        _WristFadeRange("Wrist Fade Range",Range(0,1)) = 1
