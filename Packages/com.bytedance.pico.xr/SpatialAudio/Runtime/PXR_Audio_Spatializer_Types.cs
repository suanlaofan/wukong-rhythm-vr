...
namespace PXR_Audio
{
    namespace Spatializer
    {
        ...
        {
            None = 0, // The engine does not calculate attenuation based on distance
            Fixed = 1, // Identical to None
            InverseSquare = 2, // The engine uses the InverseSquare Law to calculate distance attenuation
            Customized = ~0, // Calculate distance attenuation based on the externally provided Callback
        };
        ...
        public struct SourceConfig
        {
            ...
            public float directGain; // Direct-path gain relative to sourceGain.
            ...
            public IntPtr effectConfigPath;
