...
namespace ByteDance.PICO.Platform.Service
{
    public class SpeechService
    {
        ...
        {
            return CLIB.CLIB.ppf_Speech_InitAsrEngine();
        }
        ...
        public static int StartAsr(bool autoStop, bool showPunctual, int vadMaxDurationInSeconds)
        {
            ...
            return CLIB.CLIB.ppf_Speech_StartAsr((IntPtr) option);
        }
    ...
    public class StartAsrOptions
    {
        ...
        {
            Handle = CLIB.CLIB.ppf_StartAsrOptions_Create();
        }

        
        public void SetAutoStop(bool value)
        {
            CLIB.CLIB.ppf_StartAsrOptions_SetAutoStop(Handle, value);
        }

        
        public void SetVadMaxDurationInSeconds(int value)
        {
            CLIB.CLIB.ppf_StartAsrOptions_SetVadMaxDurationInSeconds(Handle, value);
        }

        
        public void SetShowPunctual(bool value)
        {
            CLIB.CLIB.ppf_StartAsrOptions_SetShowPunctual(Handle, value);
        }
        ...
        ~StartAsrOptions()
        {
            CLIB.CLIB.ppf_StartAsrOptions_Destroy(Handle);
        }
