...
namespace ByteDance.PICO.Platform.Service
{
    ...
    public static class RoomService
    {
        ...
        public static Task<RoomList> GetNamedRooms(int pageIndex, int pageSize)
        {
            ...
            return new Task<RoomList>(CLIB.CLIB.ppf_Room_GetNamedRooms(pageIndex, pageSize));
        }
        ...
        public static Task<Room> JoinOrCreateNamedRoom(RoomJoinPolicy joinPolicy, bool createIfNotExist, uint maxUsers, RoomOptions options)
        {
            ...
            return new Task<Room>(CLIB.CLIB.ppf_Room_JoinNamed(joinPolicy, createIfNotExist, maxUsers, options.GetHandle()));
        }
        ...
        public static Task LaunchInvitableUserFlow(UInt64 roomID)
        {
            ...
            return new Task(CLIB.CLIB.ppf_Room_LaunchInvitableUserFlow(roomID));
        }
        ...
        public static Task<Room> UpdateDataStore(UInt64 roomId, Dictionary<string, string> data)
        {
            ...
            return new Task<Room>(CLIB.CLIB.ppf_Room_UpdateDataStore(roomId, kvarray.GetHandle(), kvarray.Size));
        }
        ...
        public static Task<Room> CreateAndJoinPrivate2(RoomJoinPolicy policy, uint maxUsers, RoomOptions roomOptions)
        {
            ...
            return new Task<Room>(CLIB.CLIB.ppf_Room_CreateAndJoinPrivate2(policy, maxUsers, roomOptions.GetHandle()));
        }
        ...
        public static Task<Room> Get(UInt64 roomId)
        {
            ...
            return new Task<Room>(CLIB.CLIB.ppf_Room_Get(roomId));
        }
        ...
        public static Task<Room> GetCurrent()
        {
            ...
            return new Task<Room>(CLIB.CLIB.ppf_Room_GetCurrent());
        }
        ...
        public static Task<Room> GetCurrentForUser(string userId)
        {
            ...
            return new Task<Room>(CLIB.CLIB.ppf_Room_GetCurrentForUser(userId));
        }
        ...
        public static Task<UserList> GetInvitableUsers2(RoomOptions roomOptions = null)
        {
            ...
            if (roomOptions == null)
            {
                return new Task<UserList>(CLIB.CLIB.ppf_Room_GetInvitableUsers2(IntPtr.Zero));
            }
            else
            {
                return new Task<UserList>(CLIB.CLIB.ppf_Room_GetInvitableUsers2(roomOptions.GetHandle()));
            }
        }
        ...
        public static Task<RoomList> GetModeratedRooms(int index, int size)
        {
            ...
            return new Task<RoomList>(CLIB.CLIB.ppf_Room_GetModeratedRooms(index, size));
        }
        ...
        public static Task<Room> InviteUser(UInt64 roomId, string token)
        {
            ...
            return new Task<Room>(CLIB.CLIB.ppf_Room_InviteUser(roomId, token));
        }
        ...
        public static Task<Room> Join2(UInt64 roomId, RoomOptions options)
        {
            ...
            return new Task<Room>(CLIB.CLIB.ppf_Room_Join2(roomId, options.GetHandle()));
        }
        ...
        public static Task<Room> KickUser(UInt64 roomId, string userId, int kickDuration)
        {
            ...
            return new Task<Room>(CLIB.CLIB.ppf_Room_KickUser(roomId, userId, kickDuration));
        }
        ...
        public static Task<Room> Leave(UInt64 roomId)
        {
            ...
            return new Task<Room>(CLIB.CLIB.ppf_Room_Leave(roomId));
        }
        ...
        public static Task<Room> SetDescription(UInt64 roomId, string description)
        {
            ...
            return new Task<Room>(CLIB.CLIB.ppf_Room_SetDescription(roomId, description));
        }
        ...
        public static Task<Room> UpdateMembershipLockStatus(UInt64 roomId, RoomMembershipLockStatus membershipLockStatus)
        {
            ...
            return new Task<Room>(CLIB.CLIB.ppf_Room_UpdateMembershipLockStatus(roomId, membershipLockStatus));
        }
        ...
        public static Task UpdateOwner(UInt64 roomId, string userId)
        {
            ...
            return new Task(CLIB.CLIB.ppf_Room_UpdateOwner(roomId, userId));
        }
        ...
        public static Task<Room> UpdatePrivateRoomJoinPolicy(UInt64 roomId, RoomJoinPolicy policy)
        {
            ...
            return new Task<Room>(CLIB.CLIB.ppf_Room_UpdatePrivateRoomJoinPolicy(roomId, policy));
        }
    ...
    public class RoomOptions
    {
        public RoomOptions()
        {
            Handle = CLIB.CLIB.ppf_RoomOptions_Create();
        }
        ...
        {
            CLIB.CLIB.ppf_RoomOptions_SetDataStoreString(Handle, key, value);
        }
        ...
        {
            CLIB.CLIB.ppf_RoomOptions_ClearDataStore(Handle);
        }
        ...
        {
            CLIB.CLIB.ppf_RoomOptions_SetExcludeRecentlyMet(Handle, value);
        }
        ...
        {
            CLIB.CLIB.ppf_RoomOptions_SetMaxUserResults(Handle, value);
        }
        ...
        {
            CLIB.CLIB.ppf_RoomOptions_SetRoomId(Handle, value);
        }
        ...
        {
            CLIB.CLIB.ppf_RoomOptions_SetName(Handle, roomName);
        }
        ...
        {
            CLIB.CLIB.ppf_RoomOptions_SetPassword(Handle, password);
        }
        ...
        {
            CLIB.CLIB.ppf_RoomOptions_SetTurnOffUpdates(Handle, value);
        }
        ...
        ~RoomOptions()
        {
            CLIB.CLIB.ppf_RoomOptions_Destroy(Handle);
        }
