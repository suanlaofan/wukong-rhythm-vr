...
namespace ByteDance.PICO.Platform.Service
{
    ...
    public static class ChallengesService
    {
        ...
        public static Task<Challenge> Invite(UInt64 challengeID, string[] userID)
        {
            ...
            return new Task<Challenge>(CLIB.CLIB.ppf_Challenges_Invites(challengeID, userID));
        }
        ...
        public static Task<Challenge> Get(UInt64 challengeID)
        {
            ...
            return new Task<Challenge>(CLIB.CLIB.ppf_Challenges_Get(challengeID));
        }
            ...
            LeaderboardFilterType filter, LeaderboardStartAt startAt, int pageIdx, int pageSize)
        {
            ...
            return new Task<ChallengeEntryList>(
                CLIB.CLIB.ppf_Challenges_GetEntries(challengeID, filter, startAt, pageIdx, pageSize));
        }
            ...
            ulong afterRank, int pageIdx, int pageSize)
        {
            ...
            return new Task<ChallengeEntryList>(
                CLIB.CLIB.ppf_Challenges_GetEntriesAfterRank(challengeID, afterRank, pageIdx, pageSize));
        }
            ...
            LeaderboardStartAt startAt, string[] userIDs, int pageIdx, int pageSize)
        {
            ...
            return new Task<ChallengeEntryList>(CLIB.CLIB.ppf_Challenges_GetEntriesByIds(challengeID, startAt, userIDs, pageIdx, pageSize));
        }
        ...
        public static Task<ChallengeList> GetList(ChallengeOptions challengeOptions, int pageIdx, int pageSize)
        {
            ...
            return new Task<ChallengeList>(CLIB.CLIB.ppf_Challenges_GetList((IntPtr) challengeOptions, pageIdx, pageSize));
        }
        ...
        public static Task<Challenge> Join(UInt64 challengeID)
        {
            ...
            return new Task<Challenge>(CLIB.CLIB.ppf_Challenges_Join(challengeID));
        }
        ...
        public static Task<Challenge> Leave(UInt64 challengeID)
        {
            ...
            return new Task<Challenge>(CLIB.CLIB.ppf_Challenges_Leave(challengeID));
        }
        ...
        public static Task LaunchInvitableUserFlow(UInt64 challengeID)
        {
            ...
            return new Task(CLIB.CLIB.ppf_Challenges_LaunchInvitableUserFlow(challengeID));
        }
