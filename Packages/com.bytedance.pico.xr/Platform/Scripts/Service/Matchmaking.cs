...
namespace ByteDance.PICO.Platform.Service
{
    ...
    public static class MatchmakingService
    {
        ...
        public static Task ReportResultsInsecure(UInt64 roomId, Dictionary<string, int> data)
        {
            ...
            return new Task(CLIB.CLIB.ppf_Matchmaking_ReportResultInsecure(roomId, kvarray.GetHandle(), kvarray.Size));
        }
        ...
        public static Task<MatchmakingStats> GetStats(string pool, uint maxLevel, MatchmakingStatApproach approach = MatchmakingStatApproach.Trailing)
        {
            ...
            return new Task<MatchmakingStats>(CLIB.CLIB.ppf_Matchmaking_GetStats(pool, maxLevel, approach));
        }
        ...
        public static Task<MatchmakingBrowseResult> Browse2(string pool, MatchmakingOptions matchmakingOptions = null)
        {
            ...
            {
                return new Task<MatchmakingBrowseResult>(CLIB.CLIB.ppf_Matchmaking_Browse2(pool, IntPtr.Zero));
            }
            else
            {
                return new Task<MatchmakingBrowseResult>(CLIB.CLIB.ppf_Matchmaking_Browse2(pool, matchmakingOptions.GetHandle()));
            }
        }
        ...
        public static Task<MatchmakingBrowseResult> Browse2ForCustomPage(string pool, MatchmakingOptions matchmakingOptions = null, int pageIndex = 0, int pageSize = 5)
        {
            ...
            if (matchmakingOptions == null)
            {
                return new Task<MatchmakingBrowseResult>(CLIB.CLIB.ppf_Matchmaking_Browse2CustomPage(pool, IntPtr.Zero, pageIndex, pageSize));
            }
            else
            {
                return new Task<MatchmakingBrowseResult>(CLIB.CLIB.ppf_Matchmaking_Browse2CustomPage(pool, matchmakingOptions.GetHandle(), pageIndex, pageSize));
            }
        }
        ...
        public static Task Cancel()
        {
            ...
            return new Task(CLIB.CLIB.ppf_Matchmaking_Cancel2());
        }
        ...
        public static Task<MatchmakingEnqueueResultAndRoom> CreateAndEnqueueRoom2(string pool, MatchmakingOptions matchmakingOptions = null)
        {
            ...
            if (matchmakingOptions == null)
            {
                return new Task<MatchmakingEnqueueResultAndRoom>(CLIB.CLIB.ppf_Matchmaking_CreateAndEnqueueRoom2(pool, IntPtr.Zero));
            }
            else
            {
                return new Task<MatchmakingEnqueueResultAndRoom>(CLIB.CLIB.ppf_Matchmaking_CreateAndEnqueueRoom2(pool, matchmakingOptions.GetHandle()));
            }
        }
        ...
        public static Task<MatchmakingEnqueueResult> Enqueue2(string pool, MatchmakingOptions matchmakingOptions = null)
        {
            ...
            if (matchmakingOptions == null)
            {
                return new Task<MatchmakingEnqueueResult>(CLIB.CLIB.ppf_Matchmaking_Enqueue2(pool, IntPtr.Zero));
            }
            else
            {
                return new Task<MatchmakingEnqueueResult>(CLIB.CLIB.ppf_Matchmaking_Enqueue2(pool, matchmakingOptions.GetHandle()));
            }
        }
        ...
        public static Task<MatchmakingAdminSnapshot> GetAdminSnapshot()
        {
            ...
            return new Task<MatchmakingAdminSnapshot>(CLIB.CLIB.ppf_Matchmaking_GetAdminSnapshot());
        }
        ...
        public static Task StartMatch(UInt64 roomId)
        {
            ...
            return new Task(CLIB.CLIB.ppf_Matchmaking_StartMatch(roomId));
        }
    ...
    public class MatchmakingOptions
    {
        ...
        {
            Handle = CLIB.CLIB.ppf_MatchmakingOptions_Create();
        }
        ...
        {
            CLIB.CLIB.ppf_MatchmakingOptions_SetCreateRoomDataStoreString(Handle, key, value);
        }
        ...
        {
            CLIB.CLIB.ppf_MatchmakingOptions_ClearCreateRoomDataStore(Handle);
        }
        ...
        {
            CLIB.CLIB.ppf_MatchmakingOptions_SetCreateRoomJoinPolicy(Handle, value);
        }
        ...
        {
            CLIB.CLIB.ppf_MatchmakingOptions_SetCreateRoomMaxUsers(Handle, value);
        }
        ...
        {
            CLIB.CLIB.ppf_MatchmakingOptions_SetEnqueueDataSettingsInt(Handle, key, value);
        }
        ...
        {
            CLIB.CLIB.ppf_MatchmakingOptions_SetEnqueueDataSettingsDouble(Handle, key, value);
        }
        ...
        {
            CLIB.CLIB.ppf_MatchmakingOptions_SetEnqueueDataSettingsString(Handle, key, value);
        }
        ...
        {
            CLIB.CLIB.ppf_MatchmakingOptions_ClearEnqueueDataSettings(Handle);
        }
        ...
        {
            CLIB.CLIB.ppf_MatchmakingOptions_SetEnqueueIsDebug(Handle, value);
        }
        ...
        {
            CLIB.CLIB.ppf_MatchmakingOptions_SetEnqueueQueryKey(Handle, value);
        }
        ...
        ~MatchmakingOptions()
        {
            CLIB.CLIB.ppf_MatchmakingOptions_Destroy(Handle);
        }
