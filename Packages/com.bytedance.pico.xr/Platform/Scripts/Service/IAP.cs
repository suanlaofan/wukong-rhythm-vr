...
namespace ByteDance.PICO.Platform.Service
{
    ...
    public static class IAPService
    {
        ...
        public static Task ConsumePurchase(string sku)
        {
            ...
            return new Task(CLIB.CLIB.ppf_IAP_ConsumePurchase(sku));
        }
        ...
        public static Task<ProductList> GetProductsBySKU(string[] skus)
        {
            ...
            return new Task<ProductList>(CLIB.CLIB.ppf_IAP_GetProductsBySKU(skus));
        }
        ...
        public static Task<PurchaseList> GetViewerPurchases()
        {
            ...
            return new Task<PurchaseList>(CLIB.CLIB.ppf_IAP_GetViewerPurchases());
        }
        ...
        public static Task<Purchase> LaunchCheckoutFlow(string sku, string price, string currency)
        {
            ...
            return new Task<Purchase>(CLIB.CLIB.ppf_IAP_LaunchCheckoutFlow(sku, price, currency));
        }
        ...
        public static Task<Purchase> LaunchCheckoutFlow2(Product product)
        {
            ...
            return new Task<Purchase>(CLIB.CLIB.ppf_IAP_LaunchCheckoutFlowV2(product.SKU, product.Price, product.Currency, product.OuterId));
        }
        ...
        public static Task<Purchase> LaunchCheckoutFlow3(Product product, string orderComment)
        {
            ...
            return new Task<Purchase>(CLIB.CLIB.ppf_IAP_LaunchCheckoutFlowV3(product.SKU, product.Price, product.Currency, product.OuterId, orderComment));
        }
        ...
        public static Task<SubscriptionStatus> GetSubscriptionStatus(string sku)
        {
            ...
            return new Task<SubscriptionStatus>(CLIB.CLIB.ppf_IAP_GetSubscriptionStatus(sku));
        }
        ...
        public static Task<ProductList> GetNextProductListPage(ProductList list)
        {
            ...
            return new Task<ProductList>(
                CLIB.CLIB.ppf_IAP_GetNextProductArrayPage(list.NextPageParam)
            );
        }
        ...
        public static Task<PurchaseList> GetNextPurchaseListPage(PurchaseList list)
        {
            ...
            return new Task<PurchaseList>(CLIB.CLIB.ppf_IAP_GetNextPurchaseArrayPage(list.NextPageParam));
        }
    }
}