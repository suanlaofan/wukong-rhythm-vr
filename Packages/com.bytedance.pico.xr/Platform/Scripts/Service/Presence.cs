...
namespace ByteDance.PICO.Platform.Service
{
    ...
    public static class PresenceService
    {
        ...
        public static Task<UserList> GetInvitableUsers(InviteOptions options)
        {
            ...
            return new Task<UserList>(CLIB.CLIB.ppf_Presence_GetInvitableUsers((IntPtr) options));
        }
        ...
        public static Task<ApplicationInviteList> GetSentInvites()
        {
            ...
            return new Task<ApplicationInviteList>(CLIB.CLIB.ppf_Presence_GetSentInvites());
        }
        ...
        public static Task<ApplicationInviteList> GetNextApplicationInviteListPage(ApplicationInviteList list)
        {
            ...
            return new Task<ApplicationInviteList>(CLIB.CLIB.ppf_Presence_GetNextApplicationInviteArrayPage(list.NextPageParam));
        }
        ...
        public static Task<SendInvitesResult> SendInvites(string[] userIds)
        {
            ...
            return new Task<SendInvitesResult>(CLIB.CLIB.ppf_Presence_SendInvites(userIds));
        }
        ...
        public static Task Set(PresenceOptions options)
        {
            ...
            return new Task(CLIB.CLIB.ppf_Presence_Set((IntPtr) options));
        }
        ...
        public static Task SetDestination(string apiName)
        {
            ...
            return new Task(CLIB.CLIB.ppf_Presence_SetDestination(apiName));
        }
        ...
        public static Task SetIsJoinable(bool joinable)
        {
            ...
            return new Task(CLIB.CLIB.ppf_Presence_SetIsJoinable(joinable));
        }
        ...
        public static Task SetLobbySession(string lobbySessionId)
        {
            ...
            return new Task(CLIB.CLIB.ppf_Presence_SetLobbySession(lobbySessionId));
        }
        ...
        public static Task SetMatchSession(string matchSessionId)
        {
            ...
            return new Task(CLIB.CLIB.ppf_Presence_SetMatchSession(matchSessionId));
        }
        ...
        public static Task SetExtra(string extra)
        {
            ...
            return new Task(CLIB.CLIB.ppf_Presence_SetExtra(extra));
        }
        ...
        public static Task Clear()
        {
            ...
            return new Task(CLIB.CLIB.ppf_Presence_Clear());
        }
        ...
        public static Task<DestinationList> GetDestinations()
        {
            ...
            return new Task<DestinationList>(CLIB.CLIB.ppf_Presence_GetDestinations());
        }
        ...
        public static Task<DestinationList> GetNextDestinationListPage(DestinationList destinationList)
        {
            ...
            return new Task<DestinationList>(CLIB.CLIB.ppf_Presence_GetNextDestinationArrayPage(destinationList.NextPageParam));
        }
        ...
        public static Task LaunchInvitePanel()
        {
            ...
            return new Task(CLIB.CLIB.ppf_Presence_LaunchInvitePanel());
        }
        ...
        public static Task ShareVideoByImages(List<string> imagePaths)
        {
            ...
            return new Task(CLIB.CLIB.ppf_Presence_ShareMedia((IntPtr) options));
        }
    ...
    public class ShareMediaOptions
    {
        ...
        {
            Handle = CLIB.CLIB.ppf_ShareMediaOptions_Create();
        }


        public void SetShareMediaType(ShareMediaType value)
        {
            CLIB.CLIB.ppf_ShareMediaOptions_SetShareMediaType(Handle, value);
        }


        public void SetVideoPath(string value)
        {
            CLIB.CLIB.ppf_ShareMediaOptions_SetVideoPath(Handle, value);
        }


        public void SetVideoThumbPath(string value)
        {
            CLIB.CLIB.ppf_ShareMediaOptions_SetVideoThumbPath(Handle, value);
        }


        public void AddImagePath(string ele)
        {
            CLIB.CLIB.ppf_ShareMediaOptions_AddImagePath(Handle, ele);
        }

        public void ClearImagePaths()
        {
            CLIB.CLIB.ppf_ShareMediaOptions_ClearImagePaths(Handle);
        }


        public void SetShareAppType(ShareAppType value)
        {
            CLIB.CLIB.ppf_ShareMediaOptions_SetShareAppType(Handle, value);
        }
        ...
        ~ShareMediaOptions()
        {
            CLIB.CLIB.ppf_ShareMediaOptions_Destroy(Handle);
        }
    ...
    public class PresenceOptions
    {
        ...
        {
            Handle = CLIB.CLIB.ppf_PresenceOptions_Create();
        }
        ...
        {
            CLIB.CLIB.ppf_PresenceOptions_SetDestinationApiName(Handle, value);
        }
        ...
        {
            CLIB.CLIB.ppf_PresenceOptions_SetIsJoinable(Handle, value);
        }
        ...
        {
            CLIB.CLIB.ppf_PresenceOptions_SetLobbySessionId(Handle, value);
        }
        ...
        {
            CLIB.CLIB.ppf_PresenceOptions_SetMatchSessionId(Handle, value);
        }
        ...
        {
            CLIB.CLIB.ppf_PresenceOptions_SetExtra(Handle, value);
        }
        ...
        ~PresenceOptions()
        {
            CLIB.CLIB.ppf_PresenceOptions_Destroy(Handle);
        }
    ...
    public class InviteOptions
    {
        ...
        {
            Handle = CLIB.CLIB.ppf_InviteOptions_Create();
        }


        public void AddSuggestedUser(string ele)
        {
            CLIB.CLIB.ppf_InviteOptions_AddSuggestedUser(Handle, ele);
        }

        public void ClearSuggestedUsers()
        {
            CLIB.CLIB.ppf_InviteOptions_ClearSuggestedUsers(Handle);
        }
        ...
        ~InviteOptions()
        {
            CLIB.CLIB.ppf_InviteOptions_Destroy(Handle);
        }
