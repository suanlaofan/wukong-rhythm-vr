...
namespace ByteDance.PICO.Platform.Service
{
    ...
    public static class UserService
    {
        ...
        public static Task<string> GetAccessToken()
        {
            ...
            return new Task<string>(CLIB.CLIB.ppf_User_GetAccessToken());
        }
        ...
        public static Task<OrgScopedID> GetOrgScopedID(string userID)
        {
            ...
            return new Task<OrgScopedID>(CLIB.CLIB.ppf_User_GetOrgScopedID(userID));
        }
        ...
        public static Task<User> GetLoggedInUser()
        {
            ...
            return new Task<User>(CLIB.CLIB.ppf_User_GetLoggedInUser());
        }
        ...
        public static Task<User> Get(string userId)
        {
            ...
            return new Task<User>(CLIB.CLIB.ppf_User_Get(userId));
        }
        ...
        public static Task<UserList> GetFriends()
        {
            ...
            return new Task<UserList>(CLIB.CLIB.ppf_User_GetLoggedInUserFriends());
        }
        ...
        public static Task<UserRelationResult> GetUserRelations(string[] userIds)
        {
            ...
            return new Task<UserRelationResult>(CLIB.CLIB.ppf_User_GetRelations(userIds));
        }
        ...
        public static Task<LaunchFriendResult> LaunchFriendRequestFlow(string userId)
        {
            ...
            return new Task<LaunchFriendResult>(CLIB.CLIB.ppf_User_LaunchFriendRequestFlow(userId));
        }
        ...
        public static Task<UserRoomList> GetFriendsAndRooms()
        {
            ...
            return new Task<UserRoomList>(CLIB.CLIB.ppf_User_GetLoggedInUserFriendsAndRooms());
        }
        ...
        public static Task<UserRoomList> GetNextUserAndRoomListPage(UserRoomList list)
        {
            ...
            return new Task<UserRoomList>(CLIB.CLIB.ppf_User_GetNextUserAndRoomArrayPage(list.NextPageParam));
        }
        ...
        public static Task<UserList> GetNextUserListPage(UserList list)
        {
            ...
            return new Task<UserList>(CLIB.CLIB.ppf_User_GetNextUserArrayPage(list.NextPageParam));
        }
        ...
        public static Task<PermissionResult> GetAuthorizedPermissions()
        {
            ...
            return new Task<PermissionResult>(CLIB.CLIB.ppf_User_GetAuthorizedPermissions());
        }
        ...
        public static Task<PermissionResult> RequestUserPermissions(params string[] permissionList)
        {
            ...
            return new Task<PermissionResult>(CLIB.CLIB.ppf_User_RequestUserPermissions(permissionList));
        }
        ...
        public static Task<EntitlementCheckResult> EntitlementCheck(bool killApp = true)
        {
            ...
            return new Task<EntitlementCheckResult>(CLIB.CLIB.ppf_User_EntitlementCheck(killApp));
        }
        ...
        public static Task<string> GetIdToken()
        {
            ...
            return new Task<string>(CLIB.CLIB.ppf_User_GetIdToken());
        }
    }
}