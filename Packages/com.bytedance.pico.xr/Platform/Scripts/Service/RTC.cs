...
namespace ByteDance.PICO.Platform.Service
{
    /**
     * \ingroup Platform
     *
    ...
    public static class RtcService
    {
        ...
        public static RtcEngineInitResult InitRtcEngine()
        {
            ...
            return CLIB.CLIB.ppf_Rtc_InitRtcEngine();
        }
        ...
        public static Task<string> GetToken(string roomId, string userId, int ttl, Dictionary<RtcPrivilege, int> privileges)
        {
            ...
            return new Task<string>(CLIB.CLIB.ppf_Rtc_GetToken((IntPtr) tokenOption));
        }
        ...
        public static int JoinRoom(string roomId, string userId, string token, RtcRoomProfileType roomProfileType, bool isAutoSubscribeAudio)
        {
            ...
            return CLIB.CLIB.ppf_Rtc_JoinRoom((IntPtr) roomOption);
        }
        ...
        {
            var res = CLIB.CLIB.ppf_Rtc_JoinRoom((IntPtr) joinRoomOptions);
            if (leaveIfInRoom && res == -2)
            {
                LeaveRoom(joinRoomOptions.RoomId);
                res = CLIB.CLIB.ppf_Rtc_JoinRoom((IntPtr) joinRoomOptions);
            }
        ...
        public static int JoinRoomWithRetry(string roomId, string userId, string token, RtcRoomProfileType roomProfileType, bool isAutoSubscribeAudio)
        {
            ...
            roomOption.SetRoomProfileType(roomProfileType);
            roomOption.SetIsAutoSubscribeAudio(isAutoSubscribeAudio);
            var res = CLIB.CLIB.ppf_Rtc_JoinRoom((IntPtr) roomOption);
            if (res == -2)
            {
                LeaveRoom(roomId);
                res = CLIB.CLIB.ppf_Rtc_JoinRoom((IntPtr) roomOption);
            }
        ...
        {
            return CLIB.CLIB.ppf_Rtc_LeaveRoom(roomId);
        }
        ...
        {
            CLIB.CLIB.ppf_Rtc_SetAudioPlaybackDevice(device);
        }
        ...
        {
            CLIB.CLIB.ppf_Rtc_RoomPauseAllSubscribedStream(roomId, RtcPauseResumeMediaType.Audio);
        }
        ...
        {
            CLIB.CLIB.ppf_Rtc_RoomResumeAllSubscribedStream(roomId, RtcPauseResumeMediaType.Audio);
        }
        ...
        [MonoPInvokeCallback(typeof(CLIB.CLIB.RtcProcessAudioFrameFunction))]
        ...
        public static void RegisterLocalAudioProcessor(ProcessAudioFrameFunction processor, RtcAudioChannel channel, RtcAudioSampleRate sampleRate)
        {
            ...
            CLIB.CLIB.ppf_Rtc_RegisterLocalAudioProcessor(InnerAudioProcessor, channel, sampleRate);
        }
        ...
        public static void EnableAudioPropertiesReport(int interval)
        {
            ...
            CLIB.CLIB.ppf_Rtc_EnableAudioPropertiesReport((IntPtr) conf);
        }
        ...
        {
            CLIB.CLIB.ppf_Rtc_RoomPublishStream(roomId, RtcMediaStreamType.Audio);
        }
        ...
        {
            CLIB.CLIB.ppf_Rtc_RoomUnPublishStream(roomId, RtcMediaStreamType.Audio);
        }
        ...
        {
            CLIB.CLIB.ppf_Rtc_DestroyRoom(roomId);
        }
        ...
        {
            CLIB.CLIB.ppf_Rtc_StartAudioCapture();
        }
        ...
        {
            CLIB.CLIB.ppf_Rtc_StopAudioCapture();
        }
        ...
        {
            CLIB.CLIB.ppf_Rtc_SetCaptureVolume(RtcStreamIndex.Main, volume);
        }
        ...
        {
            CLIB.CLIB.ppf_Rtc_SetPlaybackVolume(volume);
        }
        ...
        {
            CLIB.CLIB.ppf_Rtc_SetEarMonitorMode(mode);
        }
        ...
        {
            CLIB.CLIB.ppf_Rtc_SetEarMonitorVolume(volume);
        }
        ...
        {
            CLIB.CLIB.ppf_Rtc_MuteLocalAudio(rtcMuteState);
        }
        ...
        {
            CLIB.CLIB.ppf_Rtc_UpdateToken(roomId, token);
        }
        ...
        {
            CLIB.CLIB.ppf_Rtc_SetAudioScenario(scenarioType);
        }
        ...
        {
            CLIB.CLIB.ppf_Rtc_RoomSetRemoteAudioPlaybackVolume(roomId, userId, volume);
        }
        ...
        {
            CLIB.CLIB.ppf_Rtc_RoomSubscribeStream(roomId, userId, RtcMediaStreamType.Audio);
        }
        ...
        {
            CLIB.CLIB.ppf_Rtc_RoomUnsubscribeStream(roomId, userId, RtcMediaStreamType.Audio);
        }
        ...
        public static long SendRoomBinaryMessage(string roomId, byte[] message)
        {
            ...
            var ans = CLIB.CLIB.ppf_Rtc_SendRoomBinaryMessage(roomId, ptr.ptr, message.Length);
            ptr.Free();
            return ans;
        }
        ...
        {
            return CLIB.CLIB.ppf_Rtc_SendRoomMessage(roomId, message);
        }
        ...
        {
            var ptr = new PtrManager(message);
            var ans = CLIB.CLIB.ppf_Rtc_SendUserBinaryMessage(roomId, userId, ptr.ptr, message.Length);
            ptr.Free();
            return ans;
        }
        ...
        {
            return CLIB.CLIB.ppf_Rtc_SendUserMessage(roomId, userId, message);
        }
        ...
        public static int SendStreamSyncInfo(byte[] data, int repeatCount)
        {
            ...
            var ans = CLIB.CLIB.ppf_Rtc_SendStreamSyncInfo(ptr.ptr, data.Length, (IntPtr) config);
            ptr.Free();
            return ans;
        }
    ...
    public class RtcStreamSyncInfoOptions
    {
        ...
        {
            Handle = CLIB.CLIB.ppf_RtcStreamSyncInfoOptions_Create();
        }

        public void SetRepeatCount(int value)
        {
            CLIB.CLIB.ppf_RtcStreamSyncInfoOptions_SetRepeatCount(Handle, value);
        }

        public void SetStreamIndex(RtcStreamIndex value)
        {
            CLIB.CLIB.ppf_RtcStreamSyncInfoOptions_SetStreamIndex(Handle, value);
        }

        public void SetStreamType(RtcSyncInfoStreamType value)
        {
            CLIB.CLIB.ppf_RtcStreamSyncInfoOptions_SetStreamType(Handle, value);
        }
        ...
        {
            CLIB.CLIB.ppf_RtcStreamSyncInfoOptions_Destroy(Handle);
        }
    }
    ...
    public class RtcRoomOptions
    {
        ...
        {
            Handle = CLIB.CLIB.ppf_RtcRoomOptions_Create();
        }


        public void SetRoomProfileType(RtcRoomProfileType value)
        {
            CLIB.CLIB.ppf_RtcRoomOptions_SetRoomProfileType(Handle, value);
        }


        public void SetIsAutoSubscribeAudio(bool value)
        {
            CLIB.CLIB.ppf_RtcRoomOptions_SetIsAutoSubscribeAudio(Handle, value);
        }

        public void SetRoomId(string value)
        {
            this.RoomId = value;
            CLIB.CLIB.ppf_RtcRoomOptions_SetRoomId(Handle, value);
        }


        public void SetUserId(string value)
        {
            CLIB.CLIB.ppf_RtcRoomOptions_SetUserId(Handle, value);
        }


        public void SetUserExtra(string value)
        {
            CLIB.CLIB.ppf_RtcRoomOptions_SetUserExtra(Handle, value);
        }


        public void SetToken(string value)
        {
            CLIB.CLIB.ppf_RtcRoomOptions_SetToken(Handle, value);
        }
        ...
        ~RtcRoomOptions()
        {
            CLIB.CLIB.ppf_RtcRoomOptions_Destroy(Handle);
        }
    ...
    public class RtcGetTokenOptions
    {
        ...
        {
            Handle = CLIB.CLIB.ppf_RtcGetTokenOptions_Create();
        }


        public void SetUserId(string value)
        {
            CLIB.CLIB.ppf_RtcGetTokenOptions_SetUserId(Handle, value);
        }


        public void SetRoomId(string value)
        {
            CLIB.CLIB.ppf_RtcGetTokenOptions_SetRoomId(Handle, value);
        }

        public void SetTtl(int value)
        {
            CLIB.CLIB.ppf_RtcGetTokenOptions_SetTtl(Handle, value);
        }

        public void SetPrivileges(RtcPrivilege key, int value)
        {
            CLIB.CLIB.ppf_RtcGetTokenOptions_SetPrivileges(Handle, key, value);
        }

        public void ClearPrivileges()
        {
            CLIB.CLIB.ppf_RtcGetTokenOptions_ClearPrivileges(Handle);
        }
        ...
        ~RtcGetTokenOptions()
        {
            CLIB.CLIB.ppf_RtcGetTokenOptions_Destroy(Handle);
        }
    ...
    public class RtcAudioPropertyOptions
    {
        ...
        {
            Handle = CLIB.CLIB.ppf_RtcAudioPropertyOptions_Create();
        }

        public void SetInterval(int value)
        {
            CLIB.CLIB.ppf_RtcAudioPropertyOptions_SetInterval(Handle, value);
        }

        ~RtcAudioPropertyOptions()
        {
            CLIB.CLIB.ppf_RtcAudioPropertyOptions_Destroy(Handle);
        }
