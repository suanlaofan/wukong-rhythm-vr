...
namespace ByteDance.PICO.Platform.Service
{
    ...
    public static class SportService
    {
        ...
        public static Task<SportUserInfo> GetUserInfo()
        {
            ...
            return new Task<SportUserInfo>(CLIB.CLIB.ppf_Sport_GetUserInfo());
        }
        ...
        public static Task<SportDailySummaryList> GetDailySummary(DateTime beginTime, DateTime endTime)
        {
            ...
            return new Task<SportDailySummaryList>(CLIB.CLIB.ppf_Sport_GetDailySummary(TimeUtil.DateTimeToMilliSeconds(beginTime), TimeUtil.DateTimeToMilliSeconds(endTime)));
        }
        ...
        public static Task<SportSummary> GetSummary(DateTime beginTime, DateTime endTime)
        {
            ...
            return new Task<SportSummary>(CLIB.CLIB.ppf_Sport_GetSummary(TimeUtil.DateTimeToMilliSeconds(beginTime), TimeUtil.DateTimeToMilliSeconds(endTime)));
        }
