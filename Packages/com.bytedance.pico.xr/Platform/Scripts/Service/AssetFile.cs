...
namespace ByteDance.PICO.Platform.Service
{
    ...
    public static class AssetFileService
    {
        ...
        public static Task<AssetFileDeleteResult> DeleteById(ulong assetFileId)
        {
            ...
            return new Task<AssetFileDeleteResult>(CLIB.CLIB.ppf_AssetFile_DeleteById(assetFileId));
        }
        ...
        public static Task<AssetFileDeleteResult> DeleteByName(string assetFileName)
        {
            ...
            return new Task<AssetFileDeleteResult>(CLIB.CLIB.ppf_AssetFile_DeleteByName(assetFileName));
        }
        ...
        public static Task<AssetFileDownloadResult> DownloadById(ulong assetFileId)
        {
            ...
            return new Task<AssetFileDownloadResult>(CLIB.CLIB.ppf_AssetFile_DownloadById(assetFileId));
        }
        ...
        public static Task<AssetFileDownloadResult> DownloadByName(string assetFileName)
        {
            ...
            return new Task<AssetFileDownloadResult>(CLIB.CLIB.ppf_AssetFile_DownloadByName(assetFileName));
        }
        ...
        public static Task<AssetFileDownloadCancelResult> DownloadCancelById(ulong assetFileId)
        {
            ...
            return new Task<AssetFileDownloadCancelResult>(CLIB.CLIB.ppf_AssetFile_DownloadCancelById(assetFileId));
        }
        ...
        public static Task<AssetFileDownloadCancelResult> DownloadCancelByName(string assetFileName)
        {
            ...
            return new Task<AssetFileDownloadCancelResult>(CLIB.CLIB.ppf_AssetFile_DownloadCancelByName(assetFileName));
        }
        ...
        public static Task<AssetStatus> StatusById(ulong assetId)
        {
            ...
            return new Task<AssetStatus>(CLIB.CLIB.ppf_AssetFile_StatusById(assetId));
        }
        ...
        public static Task<AssetStatus> StatusByName(string assetFileName)
        {
            ...
            return new Task<AssetStatus>(CLIB.CLIB.ppf_AssetFile_StatusByName(assetFileName));
        }
        ...
        public static Task<AssetDetailsList> GetList()
        {
            ...
            return new Task<AssetDetailsList>(CLIB.CLIB.ppf_AssetFile_GetList());
        }
        ...
        public static Task<AssetDetailsList> GetNextAssetDetailsListPage(AssetDetailsList list)
        {
            ...
            return new Task<AssetDetailsList>(CLIB.CLIB.ppf_AssetFile_GetNextAssetDetailsArrayPage(list.NextPageParam));
        }
