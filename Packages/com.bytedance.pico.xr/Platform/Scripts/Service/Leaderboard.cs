...
namespace ByteDance.PICO.Platform.Service
{
    ...
    public static class LeaderboardService
    {
        ...
        public static Task<LeaderboardList> Get(string leaderboardName)
        {
            ...
            return new Task<LeaderboardList>(CLIB.CLIB.ppf_Leaderboard_Get(leaderboardName));
        }
        ...
        public static Task<LeaderboardEntryList> GetEntries(string leaderboardName, int pageSize, int pageIdx, LeaderboardFilterType filter, LeaderboardStartAt startAt)
        {
            ...
            return new Task<LeaderboardEntryList>(CLIB.CLIB.ppf_Leaderboard_GetEntries(leaderboardName, pageSize, pageIdx, filter, startAt));
        }
            ...
            ulong afterRank)
        {
            ...
            return new Task<LeaderboardEntryList>(
                CLIB.CLIB.ppf_Leaderboard_GetEntriesAfterRank(leaderboardName, pageSize, pageIdx, afterRank));
        }
            ...
            LeaderboardStartAt startAt, string[] userIDs)
        {
            ...
            return new Task<LeaderboardEntryList>(CLIB.CLIB.ppf_Leaderboard_GetEntriesByIds(leaderboardName,
            ...
            bool forceUpdate = false)
        {
            ...
            var result = new Task<bool>(CLIB.CLIB.ppf_Leaderboard_WriteEntry(leaderboardName, score, pobj,
            ...
            long supplementaryMetric, byte[] extraData = null, bool forceUpdate = false)
        {
            ...
            GCHandle hobj = GCHandle.Alloc(extraData, GCHandleType.Pinned);
            IntPtr pobj = hobj.AddrOfPinnedObject();
            var result = new Task<bool>(CLIB.CLIB.ppf_Leaderboard_WriteEntryWithSupplementaryMetric(leaderboardName, score,
