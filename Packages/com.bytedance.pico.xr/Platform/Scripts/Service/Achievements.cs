...
namespace ByteDance.PICO.Platform.Service
{
    ...
    public static class AchievementsService
    {
        ...
        public static Task<AchievementUpdate> AddCount(string name, long count, byte[] extraData)
        {
            ...
            var result = new Task<AchievementUpdate>(CLIB.CLIB.ppf_Achievements_AddCount(name, count, pobj, (uint) (extraData != null ? extraData.Length : 0)));
            if (hobj.IsAllocated)
                hobj.Free();
            return result;
        }
        ...
        public static Task<AchievementUpdate> AddFields(string name, string fields, byte[] extraData)
        {
            ...
            GCHandle hobj = GCHandle.Alloc(extraData, GCHandleType.Pinned);
            IntPtr pobj = hobj.AddrOfPinnedObject();
            var result = new Task<AchievementUpdate>(CLIB.CLIB.ppf_Achievements_AddFields(name, fields, pobj, (uint) (extraData != null ? extraData.Length : 0)));
            if (hobj.IsAllocated)
                hobj.Free();
            return result;
        }
        ...
        public static Task<AchievementDefinitionList> GetAllDefinitions(int pageIdx, int pageSize)
        {
            ...
            return new Task<AchievementDefinitionList>(CLIB.CLIB.ppf_Achievements_GetAllDefinitions(pageIdx, pageSize));
        }
        ...
        public static Task<AchievementProgressList> GetAllProgress(int pageIdx, int pageSize)
        {
            ...
            return new Task<AchievementProgressList>(CLIB.CLIB.ppf_Achievements_GetAllProgress(pageIdx, pageSize));
        }
        ...
        public static Task<AchievementDefinitionList> GetDefinitionsByName(string[] names)
        {
            ...
            return new Task<AchievementDefinitionList>(CLIB.CLIB.ppf_Achievements_GetDefinitionsByName(names));
        }
        ...
        public static Task<AchievementProgressList> GetProgressByName(string[] names)
        {
            ...
            return new Task<AchievementProgressList>(CLIB.CLIB.ppf_Achievements_GetProgressByName(names));
        }
        ...
        public static Task<AchievementUpdate> Unlock(string name, byte[] extraData)
        {
            ...
            GCHandle hobj = GCHandle.Alloc(extraData, GCHandleType.Pinned);
            IntPtr pobj = hobj.AddrOfPinnedObject();
            var result = new Task<AchievementUpdate>(CLIB.CLIB.ppf_Achievements_Unlock(name, pobj, (uint) (extraData != null ? extraData.Length : 0)));
            if (hobj.IsAllocated)
                hobj.Free();
            return result;
        }
