...
using UnityEngine;
using SystemInfo = ByteDance.PICO.Platform.Models.SystemInfo;
...
namespace ByteDance.PICO.Platform.Service
{
    ...
    public static class ApplicationService
    {
        ...
        public static Task<string> LaunchApp(string packageName, ApplicationOptions options = null)
        {
            ...
            return new Task<string>(CLIB.CLIB.ppf_Application_LaunchOtherApp(packageName, (IntPtr) options));
        }
        ...
        public static Task<string> LaunchAppByAppId(string appId, ApplicationOptions options = null)
        {
            ...
            return new Task<string>(CLIB.CLIB.ppf_Application_LaunchOtherAppByAppID(appId, (IntPtr) options));
        }
        ...
        public static Task<string> LaunchStore()
        {
            ...
            return new Task<string>(CLIB.CLIB.ppf_Application_LaunchStore());
        }
        ...
        public static Task<ApplicationVersion> GetVersion()
        {
            ...
            return new Task<ApplicationVersion>(CLIB.CLIB.ppf_Application_GetVersion());
        }
        ...
        public static LaunchDetails GetLaunchDetails()
        {
            ...
            return new LaunchDetails(CLIB.CLIB.ppf_ApplicationLifecycle_GetLaunchDetails());
        }
        ...
        public static SystemInfo GetSystemInfo()
        {
            ...
            return new SystemInfo(CLIB.CLIB.ppf_Application_GetSystemInfo());
        }
        ...
        {
            CLIB.CLIB.ppf_ApplicationLifecycle_LogDeeplinkResult(trackId, result);
        }
    ...
    public class ApplicationOptions
    {
        ...
        {
            Handle = CLIB.CLIB.ppf_ApplicationOptions_Create();
        }


        public void SetDeeplinkMessage(string value)
        {
            CLIB.CLIB.ppf_ApplicationOptions_SetDeeplinkMessage(Handle, value);
        }
        ...
        ~ApplicationOptions()
        {
            CLIB.CLIB.ppf_ApplicationOptions_Destroy(Handle);
        }
