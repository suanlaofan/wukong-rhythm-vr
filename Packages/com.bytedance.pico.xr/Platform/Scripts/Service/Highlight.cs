...
namespace ByteDance.PICO.Platform.Service
{
    public class HighlightService
    {
        ...
        public static Task<string> StartSession()
        {
            ...
            return new Task<string>(CLIB.CLIB.ppf_Highlight_StartSession());
        }
        ...
        public static Task<CaptureInfo> CaptureScreen()
        {
            ...
            return new Task<CaptureInfo>(CLIB.CLIB.ppf_Highlight_CaptureScreen());
        }
        ...
        public static Task StartRecord()
        {
            ...
            return new Task(CLIB.CLIB.ppf_Highlight_StartRecord());
        }
        ...
        public static Task<RecordInfo> StopRecord()
        {
            ...
            return new Task<RecordInfo>(CLIB.CLIB.ppf_Highlight_StopRecord());
        }
        ...
        public static Task<SessionMedia> ListMedia(string sessionId)
        {
            ...
            return new Task<SessionMedia>(CLIB.CLIB.ppf_Highlight_ListMedia(sessionId));
        }
        ...
        public static Task SaveMedia(string jobId, string sessionId)
        {
            ...
            return new Task(CLIB.CLIB.ppf_Highlight_SaveMedia(jobId, sessionId));
        }
        ...
        public static Task ShareMedia(string jobId, string sessionId)
        {
            ...
            return new Task(CLIB.CLIB.ppf_Highlight_ShareMedia(jobId, sessionId));
        }
