...
namespace ByteDance.PICO.Platform.Service
{
    ...
    public static class NotificationService
    {
        ...
        public static Task<RoomInviteNotificationList> GetRoomInviteNotifications(int pageIdx, int pageSize)
        {
            ...
            {
                return new Task<RoomInviteNotificationList>(CLIB.CLIB.ppf_Notification_GetRoomInvites(pageIdx, pageSize));
            }
        ...
        /// </summary>
        /// <param name="notificationID">The ID of the notification to mark.</param>
        ...
        public static Task MarkAsRead(UInt64 notificationID)
        {
            if (CoreService.IsInitialized())
            {
                return new Task(CLIB.CLIB.ppf_Notification_MarkAsRead(notificationID));
            }
