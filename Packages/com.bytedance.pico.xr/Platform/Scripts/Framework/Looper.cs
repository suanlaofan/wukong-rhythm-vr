...
using ByteDance.PICO.Platform.Service;
using UnityEngine;
...
namespace ByteDance.PICO.Platform.Framework
{
    public class Looper
    {
        ...
        public static Message PopMessage()
        {
            ...
            var handle = CLIB.CLIB.ppf_PopMessage();
            if (handle == IntPtr.Zero)
            {
                return null;
            }

            MessageType messageType =  CLIB.CLIB.ppf_Message_GetType(handle);
            ...
            CLIB.CLIB.ppf_FreeMessage(handle);
            return msg;
        }
