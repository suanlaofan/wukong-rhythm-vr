...
using ByteDance.PICO.Platform.Models;


namespace ByteDance.PICO.Platform.Framework
{
    public class MessageQueue
    {
        ...
        {
            Message msg = null;
            MessageType messageType = CLIB.CLIB.ppf_Message_GetType(msgPointer);
            switch (messageType)
            {
                case MessageType.PlatformInitializeAndroidAsynchronous:
                {
                    msg = new Message<PlatformInitializeResult>(msgPointer, ptr => { return (PlatformInitializeResult) CLIB.CLIB.ppf_Message_GetInt32(ptr); });
                    break;
                }
                ...
                case MessageType.Notification_Speech_OnAsrResult:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetAsrResult(ptr);
                ...
                case MessageType.Notification_Speech_OnSpeechError:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetSpeechError(ptr);
                ...
                {
                    msg = new Message<string>(msgPointer, ptr => { return CLIB.CLIB.ppf_Message_GetString(ptr); });
                    break;
                }
                case MessageType.Highlight_CaptureScreen:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetCaptureInfo(ptr);
                ...
                case MessageType.Highlight_ListMedia:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetSessionMedia(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.Notification_Highlight_OnRecordStop:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetRecordInfo(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.Compliance_DetectSensitive:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetDetectSensitiveResult(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.Sport_GetSummary:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetSportSummary(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.Sport_GetDailySummary:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetSportDailySummaryArray(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.Sport_GetUserInfo:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetSportUserInfo(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.User_EntitlementCheck:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetEntitlementCheckResult(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.User_RequestUserPermissions:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetPermissionResult(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.User_GetLoggedInUserFriendsAndRooms:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetUserAndRoomArray(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.Presence_GetSentInvites:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetApplicationInviteArray(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.Presence_SendInvites:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetSendInvitesResult(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.Presence_GetDestinations:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetDestinationArray(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.Notification_Presence_JoinIntentReceived:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetPresenceJoinIntent(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.Application_GetVersion:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetApplicationVersion(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.User_Get:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetUser(ptr);
                        if (obj == IntPtr.Zero) return null;
                        return new User(obj);
                    });
                    break;
                ...
                case MessageType.User_GetOrgScopedID:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetOrgScopedID(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.User_LaunchFriendRequestFlow:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetLaunchFriendRequestFlowResult(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.Presence_GetInvitableUsers:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetUserArray(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.User_GetRelations:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetUserRelationResult(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.Notification_Rtc_OnRoomMessageReceived:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetRtcRoomMessageReceived(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.Notification_Rtc_OnUserMessageReceived:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetRtcUserMessageReceived(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.Notification_Rtc_OnUserMessageSendResult:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetRtcMessageSendResult(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.Notification_Rtc_OnUserBinaryMessageReceived:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetRtcBinaryMessageReceived(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.Notification_Rtc_OnUserPublishStream:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetRtcUserPublishInfo(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.Notification_Rtc_OnUserUnPublishStream:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetRtcUserUnPublishInfo(ptr);
                        if (obj == IntPtr.Zero)
                        {
                            return null;
                        }
                ...
                case MessageType.Notification_Rtc_OnStreamSyncInfoReceived:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetRtcStreamSyncInfo(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.Notification_Rtc_OnRoomError:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetRtcRoomError(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.Notification_Rtc_OnRoomWarn:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetRtcRoomWarn(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                {
                    msg = new Message<RtcConnectionState>(msgPointer, ptr => { return (RtcConnectionState) CLIB.CLIB.ppf_Message_GetInt32(ptr); });
                    break;
                }
                case MessageType.Notification_Rtc_OnError:
                case MessageType.Notification_Rtc_OnWarn:
                {
                    msg = new Message<Int32>(msgPointer, ptr => { return CLIB.CLIB.ppf_Message_GetInt32(ptr); });
                    break;
                }
                case MessageType.Notification_Rtc_OnRoomStats:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetRtcRoomStats(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.Notification_Rtc_OnJoinRoom:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetRtcJoinRoomResult(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.Notification_Rtc_OnLeaveRoom:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetRtcLeaveRoomResult(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.Notification_Rtc_OnUserLeaveRoom:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetRtcUserLeaveInfo(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.Notification_Rtc_OnUserJoinRoom:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetRtcUserJoinInfo(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                {
                    msg = new Message<RtcAudioPlaybackDevice>(msgPointer, ptr => { return (RtcAudioPlaybackDevice) CLIB.CLIB.ppf_Message_GetInt32(ptr); });
                    break;
                }
                ...
                case MessageType.Notification_Rtc_OnMediaDeviceStateChanged:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetRtcMediaDeviceChangeInfo(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.Notification_Rtc_OnLocalAudioPropertiesReport:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetRtcLocalAudioPropertiesReport(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.Notification_Rtc_OnRemoteAudioPropertiesReport:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetRtcRemoteAudioPropertiesReport(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.Notification_Rtc_OnUserMuteAudio:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetRtcMuteInfo(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.IAP_GetViewerPurchases:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetPurchaseArray(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.IAP_GetSubscriptionStatus:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetSubscriptionStatus(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.IAP_LaunchCheckoutFlow:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetPurchase(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.IAP_GetProductsBySKU:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetProductArray(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.AssetFile_DeleteByName:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetAssetFileDeleteResult(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.AssetFile_DownloadByName:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetAssetFileDownloadResult(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.AssetFile_DownloadCancelByName:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetAssetFileDownloadCancelResult(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.AssetFile_GetNextAssetDetailsArrayPage:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetAssetDetailsArray(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.AssetFile_StatusByName:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetAssetStatus(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.Notification_AssetFile_DownloadUpdate:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetAssetFileDownloadUpdate(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.Notification_AssetFile_DeleteForSafety:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetAssetFileDeleteForSafety(ptr);
                        if (obj == IntPtr.Zero) return null;
                ...
                case MessageType.Matchmaking_GetAdminSnapshot:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetMatchmakingAdminSnapshot(ptr);
                ...
                case MessageType.Matchmaking_Browse2:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetMatchmakingBrowseResult(ptr);
                ...
                case MessageType.Matchmaking_Browse2CustomPage:
                {
                    msg = new Message<MatchmakingBrowseResult>(msgPointer, ptr =>
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetMatchmakingBrowseCustomPageResult(ptr);
                        return new MatchmakingBrowseResult(obj);
                    });
                    break;
                }
                ...
                case MessageType.Matchmaking_EnqueueRoom2:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetMatchmakingEnqueueResult(ptr);
                ...
                case MessageType.Matchmaking_CreateAndEnqueueRoom2:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetMatchmakingEnqueueResultAndRoom(ptr);
                ...
                case MessageType.Matchmaking_GetStats:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetMatchmakingStats(ptr);
                ...
                case MessageType.Room_Get:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetRoom(ptr);
                        return new Room(obj);
                    });
                    break;
                }
                ...
                case MessageType.Room_GetNextRoomArrayPage:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetRoomArray(ptr);
                ...
                case MessageType.PlatformGameInitializeAsynchronous:
                {
                    ...
                    {
                        var objHandle = CLIB.CLIB.ppf_Message_GetPlatformGameInitialize(ptr);
                        var obj = CLIB.CLIB.ppf_PlatformGameInitialize_GetResult(objHandle);
                        return obj;
                    });
                    break;
                }
                case MessageType.Notification_Game_ConnectionEvent:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetGameConnectionEvent(ptr);
                        return obj;
                    });
                    break;
                }
                case MessageType.Notification_Game_RequestFailed:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetGameRequestFailedReason(ptr);
                        return obj;
                    });
                    break;
                }
                ...
                case MessageType.Leaderboard_GetNextLeaderboardArrayPage:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetLeaderboardArray(ptr);
                ...
                case MessageType.Leaderboard_GetPreviousEntries:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetLeaderboardEntryArray(ptr);
                ...
                case MessageType.Leaderboard_WriteEntryWithSupplementaryMetric:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetLeaderboardUpdateStatus(ptr);
                        return CLIB.CLIB.ppf_LeaderboardUpdateStatus_GetDidUpdate(obj);
                    });
                    break;
                }
                ...
                case MessageType.Achievements_GetNextAchievementDefinitionArrayPage:
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetAchievementDefinitionArray(ptr);
                ...
                case MessageType.Achievements_GetProgressByName:
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetAchievementProgressArray(ptr);
                ...
                case MessageType.Achievements_Unlock:
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetAchievementUpdate(ptr);
                ...
                case MessageType.Notification_GetRoomInvites:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetRoomInviteNotificationArray(ptr);
                ...
                case MessageType.Challenges_Leave:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetChallenge(ptr);
                ...
                case MessageType.Challenges_GetList:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetChallengeArray(ptr);
                ...
                case MessageType.Challenges_GetEntriesByIds:
                {
                    ...
                    {
                        var obj = CLIB.CLIB.ppf_Message_GetChallengeEntryArray(ptr);
