...
namespace ByteDance.PICO.Platform.Framework
{
    public class Error
    {
        ...
        {
            this.Code = CLIB.CLIB.ppf_Error_GetCode(handle);
            this.Message = CLIB.CLIB.ppf_Error_GetMessage(handle);
        }
...
namespace ByteDance.PICO.Platform.Framework
{
    public class Message
    {
        ...
        {
            Type = CLIB.CLIB.ppf_Message_GetType(msgPointer);
            RequestID = CLIB.CLIB.ppf_Message_GetRequestID(msgPointer);
            if (CLIB.CLIB.ppf_Message_IsError(msgPointer))
            {
                Error = new Error(CLIB.CLIB.ppf_Message_GetError(msgPointer));
            }
        }
    ...
    public static class CommonParsers
    {
        ...
        {
            return new Message<string>(msgPointer, ptr => { return CLIB.CLIB.ppf_Message_GetString(ptr); });
        }
