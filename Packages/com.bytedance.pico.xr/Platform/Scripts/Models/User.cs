...
namespace ByteDance.PICO.Platform.Models
{
    ...
    public class User
    {
        ...
        {
            DisplayName = CLIB.CLIB.ppf_User_GetDisplayName(obj);
            ImageUrl = CLIB.CLIB.ppf_User_GetImageUrl(obj);
            ID = CLIB.CLIB.ppf_User_GetID(obj);
            InviteToken = CLIB.CLIB.ppf_User_GetInviteToken(obj);
            PresenceStatus = CLIB.CLIB.ppf_User_GetPresenceStatus(obj);
            Gender = CLIB.CLIB.ppf_User_GetGender(obj);
            Presence = CLIB.CLIB.ppf_User_GetPresence(obj);
            PresenceDeeplinkMessage = CLIB.CLIB.ppf_User_GetPresenceDeeplinkMessage(obj);
            PresenceDestinationApiName = CLIB.CLIB.ppf_User_GetPresenceDestinationApiName(obj);
            PresenceLobbySessionId = CLIB.CLIB.ppf_User_GetPresenceLobbySessionId(obj);
            PresenceMatchSessionId = CLIB.CLIB.ppf_User_GetPresenceMatchSessionId(obj);
            PresenceExtra = CLIB.CLIB.ppf_User_GetPresenceExtra(obj);
            PresenceIsJoinable = CLIB.CLIB.ppf_User_GetPresenceIsJoinable(obj);
            SmallImageUrl = CLIB.CLIB.ppf_User_GetSmallImageUrl(obj);
            InviteToken = CLIB.CLIB.ppf_User_GetInviteToken(obj);
            StoreRegion = CLIB.CLIB.ppf_User_GetStoreRegion(obj);
        }
    }
    ...
    public class UserList : MessageArray<User>
    {
        ...
        {
            var count = (int) CLIB.CLIB.ppf_UserArray_GetSize(a);
            this.Capacity = count;
            for (int i = 0; i < count; i++)
            {
                this.Add(new User(CLIB.CLIB.ppf_UserArray_GetElement(a, (UIntPtr) i)));
            }

            NextPageParam = CLIB.CLIB.ppf_UserArray_GetNextPageParam(a);
        }
    }
    ...
    public class OrgScopedID
    {
        ...
        {
            ID = CLIB.CLIB.ppf_OrgScopedID_GetID(o);
        }
    }
    ...
    public class LaunchFriendResult
    {
        ...
        {
            DidCancel = CLIB.CLIB.ppf_LaunchFriendRequestFlowResult_GetDidCancel(obj);
            DidSendRequest = CLIB.CLIB.ppf_LaunchFriendRequestFlowResult_GetDidSendRequest(obj);
        }
    }
    ...
    public class UserRoom
    {
        ...
        {
            User = new User(CLIB.CLIB.ppf_UserAndRoom_GetUser(o));
            var ptr = CLIB.CLIB.ppf_UserAndRoom_GetRoom(o);
            if (ptr != IntPtr.Zero)
            {
                Room = new Room(ptr);
            }
    ...
    public class UserRoomList : MessageArray<UserRoom>
    {
        ...
        {
            var count = (int) CLIB.CLIB.ppf_UserAndRoomArray_GetSize(a);
            this.Capacity = count;
            for (int i = 0; i < count; i++)
            {
                this.Add(new UserRoom(CLIB.CLIB.ppf_UserAndRoomArray_GetElement(a, (UIntPtr) i)));
            }

            NextPageParam = CLIB.CLIB.ppf_UserAndRoomArray_GetNextPageParam(a);
        }
    }
    ...
    public class PermissionResult
    {
        ...
        {
            {
                int sz = (int) CLIB.CLIB.ppf_PermissionResult_GetAuthorizedPermissionsSize(o);
                AuthorizedPermissions = new string[sz];
                for (int i = 0; i < sz; i++)
                {
                    AuthorizedPermissions[i] = CLIB.CLIB.ppf_PermissionResult_GetAuthorizedPermissions(o, (UIntPtr) i);
                }
            }

            AccessToken = CLIB.CLIB.ppf_PermissionResult_GetAccessToken(o);
            UserID = CLIB.CLIB.ppf_PermissionResult_GetUserID(o);
        }
    }
    ...
    public class UserRelationResult : Dictionary<string, UserRelationType>
    {
        ...
        {
            {
                int sz = (int) CLIB.CLIB.ppf_UserRelationResult_GetRelationsSize(o);
                for (int i = 0; i < sz; i++)
                {
                    string userId = CLIB.CLIB.ppf_UserRelationResult_GetRelationsKey(o, i);
                    UserRelationType relation = CLIB.CLIB.ppf_UserRelationResult_GetRelationsValue(o, i);
                    Add(userId, relation);
                }
            }
        }
    ...
    public class EntitlementCheckResult
    {
        ...
        {
            HasEntitlement = CLIB.CLIB.ppf_EntitlementCheckResult_GetHasEntitlement(o);
            StatusCode = CLIB.CLIB.ppf_EntitlementCheckResult_GetStatusCode(o);
            StatusMessage = CLIB.CLIB.ppf_EntitlementCheckResult_GetStatusMessage(o);
        }
    }
}