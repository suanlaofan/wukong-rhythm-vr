...
namespace ByteDance.PICO.Platform.Models
{
    ...
    public class MatchmakingAdminSnapshot
    {
        ...
        {
            CandidateList = new MatchmakingAdminSnapshotCandidateList(CLIB.CLIB.ppf_MatchmakingAdminSnapshot_GetCandidates(o));
            MyCurrentThreshold = CLIB.CLIB.ppf_MatchmakingAdminSnapshot_GetMyCurrentThreshold(o);
        }
    }
    ...
    public class MatchmakingAdminSnapshotCandidate
    {
        ...
        {
            CanMatch = CLIB.CLIB.ppf_MatchmakingAdminSnapshotCandidate_GetCanMatch(o);
            MyTotalScore = CLIB.CLIB.ppf_MatchmakingAdminSnapshotCandidate_GetMyTotalScore(o);
            TheirCurrentThreshold = CLIB.CLIB.ppf_MatchmakingAdminSnapshotCandidate_GetTheirCurrentThreshold(o);
        }
    }
    /// <summary>
    ...
    public class MatchmakingAdminSnapshotCandidateList : MessageArray<MatchmakingAdminSnapshotCandidate>
    {
        ...
        {
            var count = (int) CLIB.CLIB.ppf_MatchmakingAdminSnapshotCandidateArray_GetSize(a);
            this.Capacity = count;
            TotalCount = (ulong)CLIB.CLIB.ppf_MatchmakingAdminSnapshotCandidateArray_GetTotalCount(a);
            for (int i = 0; i < count; i++)
            {
                this.Add(new MatchmakingAdminSnapshotCandidate(CLIB.CLIB.ppf_MatchmakingAdminSnapshotCandidateArray_GetElement(a, (UIntPtr) i)));
            }
        }
    }
    ...
    public class MatchmakingBrowseResult
    {
        ...
        {
            EnqueueResult = new MatchmakingEnqueueResult(CLIB.CLIB.ppf_MatchmakingBrowseResult_GetEnqueueResult(o));
            MatchmakingRooms = new MatchmakingRoomList(CLIB.CLIB.ppf_MatchmakingBrowseResult_GetRooms(o));
        }
    }
    ...
    public class MatchmakingEnqueueResult
    {
        ...
        {
            {
                var pointer = CLIB.CLIB.ppf_MatchmakingEnqueueResult_GetAdminSnapshot(o);
            ...
            AverageWait = CLIB.CLIB.ppf_MatchmakingEnqueueResult_GetAverageWait(o);
            MatchesInLastHourCount = CLIB.CLIB.ppf_MatchmakingEnqueueResult_GetMatchesInLastHourCount(o);
            MaxExpectedWait = CLIB.CLIB.ppf_MatchmakingEnqueueResult_GetMaxExpectedWait(o);
            Pool = CLIB.CLIB.ppf_MatchmakingEnqueueResult_GetPool(o);
            RecentMatchPercentage = CLIB.CLIB.ppf_MatchmakingEnqueueResult_GetRecentMatchPercentage(o);
        }
    }
    ...
    public class MatchmakingEnqueueResultAndRoom
    {
        ...
        {
            MatchmakingEnqueueResult = new MatchmakingEnqueueResult(CLIB.CLIB.ppf_MatchmakingEnqueueResultAndRoom_GetMatchmakingEnqueueResult(o));
            Room = new Room(CLIB.CLIB.ppf_MatchmakingEnqueueResultAndRoom_GetRoom(o));
        }
    }
    ...
    public class MatchmakingRoom
    {
        ...
        {
            this.PingTime = CLIB.CLIB.ppf_MatchmakingRoom_GetPingTime(o);
            this.Room = new Models.Room(CLIB.CLIB.ppf_MatchmakingRoom_GetRoom(o));
            this.HasPingTime = CLIB.CLIB.ppf_MatchmakingRoom_HasPingTime(o);
        }
    }
    /**
    ...
    public class MatchmakingRoomList : MessageArray<MatchmakingRoom>
    {
        ...
        {
            TotalCount = CLIB.CLIB.ppf_MatchmakingRoomArray_GetTotalCount(a);
            int count = (int) CLIB.CLIB.ppf_MatchmakingRoomArray_GetSize(a);
            this.Capacity = count;
            for (uint i = 0; i < count; i++)
            {
                this.Add(new MatchmakingRoom(CLIB.CLIB.ppf_MatchmakingRoomArray_GetElement(a, (UIntPtr) i)));
            }
        }
    }
    ...
    public class MatchmakingStats
    {
        ...
        {
            DrawCount = CLIB.CLIB.ppf_MatchmakingStats_GetDrawCount(o);
            LossCount = CLIB.CLIB.ppf_MatchmakingStats_GetLossCount(o);
            SkillLevel = CLIB.CLIB.ppf_MatchmakingStats_GetSkillLevel(o);
            SkillMean = CLIB.CLIB.ppf_MatchmakingStats_GetSkillMean(o);
            SkillStandardDeviation = CLIB.CLIB.ppf_MatchmakingStats_GetSkillStandardDeviation(o);
            WinCount = CLIB.CLIB.ppf_MatchmakingStats_GetWinCount(o);
        }
    }
}