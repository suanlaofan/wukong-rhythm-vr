...
namespace ByteDance.PICO.Platform.Models
{
    ...
    public class RtcBinaryMessageReceived
    {
        ...
        {
            UserId = CLIB.CLIB.ppf_RtcBinaryMessageReceived_GetUserId(o);
            var ptr = CLIB.CLIB.ppf_RtcBinaryMessageReceived_GetData(o);
            var sz = CLIB.CLIB.ppf_RtcBinaryMessageReceived_GetLength(o);
            Data = MarshalUtil.ByteArrayFromNative(ptr, (uint) sz);
            RoomId = CLIB.CLIB.ppf_RtcBinaryMessageReceived_GetRoomId(o);
        }
    }
    ...
    public class RtcAudioFrame
    {
        ...
        {
            Channel = CLIB.CLIB.ppf_RtcAudioFrame_GetChannel(o);
            DataSize = CLIB.CLIB.ppf_RtcAudioFrame_GetDataSize(o);
            SampleRate = CLIB.CLIB.ppf_RtcAudioFrame_GetSampleRate(o);
            TimeStampInUs = CLIB.CLIB.ppf_RtcAudioFrame_GetTimeStampInUs(o);
            Data = CLIB.CLIB.ppf_RtcAudioFrame_GetData(o);
        }
    ...
    public class RtcMessageSendResult
    {
        ...
        {
            MessageId = CLIB.CLIB.ppf_RtcMessageSendResult_GetMessageId(o);
            Error = CLIB.CLIB.ppf_RtcMessageSendResult_GetError(o);
            RoomId = CLIB.CLIB.ppf_RtcMessageSendResult_GetRoomId(o);
        }
    }


    /// <summary>
    /// When the remote user canceled publishing stream to the room, you will receive a notification.
    /// </summary>
    public class RtcUserUnPublishInfo
    {
        ...
        {
            UserId = CLIB.CLIB.ppf_RtcUserUnPublishInfo_GetUserId(o);
            MediaStreamType = CLIB.CLIB.ppf_RtcUserUnPublishInfo_GetMediaStreamType(o);
            Reason = CLIB.CLIB.ppf_RtcUserUnPublishInfo_GetReason(o);
            RoomId = CLIB.CLIB.ppf_RtcUserUnPublishInfo_GetRoomId(o);
        }
    }
    ...
    public class RtcUserPublishInfo
    {
        ...
        {
            UserId = CLIB.CLIB.ppf_RtcUserPublishInfo_GetUserId(o);
            MediaStreamType = CLIB.CLIB.ppf_RtcUserPublishInfo_GetMediaStreamType(o);
            RoomId = CLIB.CLIB.ppf_RtcUserPublishInfo_GetRoomId(o);
        }
    }
    ...
    public class RtcRoomMessageReceived
    {
        ...
        {
            UserId = CLIB.CLIB.ppf_RtcRoomMessageReceived_GetUserId(o);
            Message = CLIB.CLIB.ppf_RtcRoomMessageReceived_GetMessage(o);
            RoomId = CLIB.CLIB.ppf_RtcRoomMessageReceived_GetRoomId(o);
        }
    }
    ...
    public class RtcUserMessageReceived
    {
        ...
        {
            UserId = CLIB.CLIB.ppf_RtcUserMessageReceived_GetUserId(o);
            Message = CLIB.CLIB.ppf_RtcUserMessageReceived_GetMessage(o);
            RoomId = CLIB.CLIB.ppf_RtcUserMessageReceived_GetRoomId(o);
        }
    }
    ...
    public class RtcStreamSyncInfo
    {
        ...
        {
            StreamKey = new RtcRemoteStreamKey(CLIB.CLIB.ppf_RtcStreamSyncInfo_GetStreamKey(o));
            StreamType = CLIB.CLIB.ppf_RtcStreamSyncInfo_GetStreamType(o);
            var ptr = CLIB.CLIB.ppf_RtcStreamSyncInfo_GetData(o);
            var sz = CLIB.CLIB.ppf_RtcStreamSyncInfo_GetLength(o);
            Data = MarshalUtil.ByteArrayFromNative(ptr, (uint) sz);
        }
    }
    ...
    public class RtcAudioPropertyInfo
    {
        ...
        {
            Volume = CLIB.CLIB.ppf_RtcAudioPropertyInfo_GetVolume(o);
        }
    }
    ...
    public class RtcJoinRoomResult
    {
        ...
        {
            RoomId = CLIB.CLIB.ppf_RtcJoinRoomResult_GetRoomId(o);
            UserId = CLIB.CLIB.ppf_RtcJoinRoomResult_GetUserId(o);
            ErrorCode = CLIB.CLIB.ppf_RtcJoinRoomResult_GetErrorCode(o);
            Elapsed = CLIB.CLIB.ppf_RtcJoinRoomResult_GetElapsed(o);
            JoinType = CLIB.CLIB.ppf_RtcJoinRoomResult_GetJoinType(o);
        }
    }
    ...
    public class RtcLeaveRoomResult
    {
        ...
        {
            RoomId = CLIB.CLIB.ppf_RtcLeaveRoomResult_GetRoomId(o);
        }
    }
    ...
    public class RtcLocalAudioPropertiesInfo
    {
        ...
        {
            StreamIndex = CLIB.CLIB.ppf_RtcLocalAudioPropertiesInfo_GetStreamIndex(o);
            AudioPropertyInfo = new RtcAudioPropertyInfo(CLIB.CLIB.ppf_RtcLocalAudioPropertiesInfo_GetAudioPropertyInfo(o));
        }
    }
    ...
    public class RtcLocalAudioPropertiesReport
    {
        ...
        {
            ulong total = (ulong) CLIB.CLIB.ppf_RtcLocalAudioPropertiesReport_GetAudioPropertiesInfosSize(o);
            AudioPropertiesInfos = new RtcLocalAudioPropertiesInfo[total];
            for (uint i = 0; i < total; i++)
            {
                AudioPropertiesInfos[i] = new RtcLocalAudioPropertiesInfo(CLIB.CLIB.ppf_RtcLocalAudioPropertiesReport_GetAudioPropertiesInfos(o, (UIntPtr) i));
            }
        }
    }
    ...
    public class RtcMediaDeviceChangeInfo
    {
        ...
        {
            DeviceId = CLIB.CLIB.ppf_RtcMediaDeviceChangeInfo_GetDeviceId(o);
            DeviceType = CLIB.CLIB.ppf_RtcMediaDeviceChangeInfo_GetDeviceType(o);
            DeviceState = CLIB.CLIB.ppf_RtcMediaDeviceChangeInfo_GetDeviceState(o);
            DeviceError = CLIB.CLIB.ppf_RtcMediaDeviceChangeInfo_GetDeviceError(o);
        }
    }
    ...
    public class RtcMuteInfo
    {
        ...
        {
            UserId = CLIB.CLIB.ppf_RtcMuteInfo_GetUserId(o);
            MuteState = CLIB.CLIB.ppf_RtcMuteInfo_GetMuteState(o);
        }
    }
    ...
    public class RtcRemoteAudioPropertiesInfo
    {
        ...
        {
            StreamKey = new RtcRemoteStreamKey(CLIB.CLIB.ppf_RtcRemoteAudioPropertiesInfo_GetStreamKey(o));
            AudioPropertiesInfo = new RtcAudioPropertyInfo(CLIB.CLIB.ppf_RtcRemoteAudioPropertiesInfo_GetAudioPropertiesInfo(o));
        }
    }
    ...
    public class RtcRemoteAudioPropertiesReport
    {
        ...
        {
            AudioPropertiesInfos = new RtcRemoteAudioPropertiesInfo[(int) CLIB.CLIB.ppf_RtcRemoteAudioPropertiesReport_GetAudioPropertiesInfosSize(o)];
            for (uint i = 0; i < AudioPropertiesInfos.Length; i++)
            {
                AudioPropertiesInfos[i] = new RtcRemoteAudioPropertiesInfo(CLIB.CLIB.ppf_RtcRemoteAudioPropertiesReport_GetAudioPropertiesInfos(o, (UIntPtr) i));
            }

            TotalRemoteVolume = CLIB.CLIB.ppf_RtcRemoteAudioPropertiesReport_GetTotalRemoteVolume(o);
        }
    }
    ...
    public class RtcRemoteStreamKey
    {
        ...
        {
            RoomId = CLIB.CLIB.ppf_RtcRemoteStreamKey_GetRoomId(o);
            UserId = CLIB.CLIB.ppf_RtcRemoteStreamKey_GetUserId(o);
            RtcStreamIndex = CLIB.CLIB.ppf_RtcRemoteStreamKey_GetStreamIndex(o);
        }
    }
    ...
    public class RtcRoomError
    {
        ...
        {
            Code = CLIB.CLIB.ppf_RtcRoomError_GetCode(o);
            RoomId = CLIB.CLIB.ppf_RtcRoomError_GetRoomId(o);
        }
    }
    ...
    public class RtcRoomStats
    {
        ...
        {
            TotalDuration = CLIB.CLIB.ppf_RtcRoomStats_GetTotalDuration(o);
            UserCount = CLIB.CLIB.ppf_RtcRoomStats_GetUserCount(o);
            RoomId = CLIB.CLIB.ppf_RtcRoomStats_GetRoomId(o);
        }
    }
    ...
    public class RtcRoomWarn
    {
        ...
        {
            Code = CLIB.CLIB.ppf_RtcRoomWarn_GetCode(o);
            RoomId = CLIB.CLIB.ppf_RtcRoomWarn_GetRoomId(o);
        }
    }
    ...
    public class RtcUserJoinInfo
    {
        ...
        {
            UserId = CLIB.CLIB.ppf_RtcUserJoinInfo_GetUserId(o);
            UserExtra = CLIB.CLIB.ppf_RtcUserJoinInfo_GetUserExtra(o);
            Elapsed = CLIB.CLIB.ppf_RtcUserJoinInfo_GetElapsed(o);
            RoomId = CLIB.CLIB.ppf_RtcUserJoinInfo_GetRoomId(o);
        }
    }
    ...
    public class RtcUserLeaveInfo
    {
        ...
        {
            UserId = CLIB.CLIB.ppf_RtcUserLeaveInfo_GetUserId(o);
            OfflineReason = CLIB.CLIB.ppf_RtcUserLeaveInfo_GetOfflineReason(o);
            RoomId = CLIB.CLIB.ppf_RtcUserLeaveInfo_GetRoomId(o);
        }
    }
}