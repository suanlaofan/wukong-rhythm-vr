...
namespace ByteDance.PICO.Platform.Models
{
    ...
    public class AssetDetails
    {
        ...
        {
            AssetId = CLIB.CLIB.ppf_AssetDetails_GetAssetId(o);
            AssetType = CLIB.CLIB.ppf_AssetDetails_GetAssetType(o);
            DownloadStatus = CLIB.CLIB.ppf_AssetDetails_GetDownloadStatus(o);
            IapStatus = CLIB.CLIB.ppf_AssetDetails_GetIapStatus(o);
            Filepath = CLIB.CLIB.ppf_AssetDetails_GetFilepath(o);
            Metadata = CLIB.CLIB.ppf_AssetDetails_GetMetadata(o);
            Filename = CLIB.CLIB.ppf_AssetDetails_GetFilename(o);
            Version = CLIB.CLIB.ppf_AssetDetails_GetVersion(o);
            IapSku = CLIB.CLIB.ppf_AssetDetails_GetIapSku(o);
            IapName = CLIB.CLIB.ppf_AssetDetails_GetIapName(o);
            IapPrice = CLIB.CLIB.ppf_AssetDetails_GetIapPrice(o);
            IapCurrency = CLIB.CLIB.ppf_AssetDetails_GetIapCurrency(o);
            IapDescription = CLIB.CLIB.ppf_AssetDetails_GetIapDescription(o);
            IapIcon = CLIB.CLIB.ppf_AssetDetails_GetIapIcon(o);
        }
    }
    ...
    public class AssetDetailsList : MessageArray<AssetDetails>
    {
        ...
        {
            var count = (int) CLIB.CLIB.ppf_AssetDetailsArray_GetSize(a);
            this.Capacity = count;
            for (int i = 0; i < count; i++)
            {
                this.Add(new AssetDetails(CLIB.CLIB.ppf_AssetDetailsArray_GetElement(a, (UIntPtr) i)));
            }

            NextPageParam = CLIB.CLIB.ppf_AssetDetailsArray_GetNextPageParam(a);
        }
    }
    ...
    public class AssetFileDeleteForSafety
    {
        ...
        {
            AssetId = CLIB.CLIB.ppf_AssetFileDeleteForSafety_GetAssetId(o);
            Reason = CLIB.CLIB.ppf_AssetFileDeleteForSafety_GetReason(o);
        }
    }
    ...
    public class AssetFileDeleteResult
    {
        ...
        {
            Filepath = CLIB.CLIB.ppf_AssetFileDeleteResult_GetFilepath(o);
            Success = CLIB.CLIB.ppf_AssetFileDeleteResult_GetSuccess(o);
            AssetId = CLIB.CLIB.ppf_AssetFileDeleteResult_GetAssetId(o);
        }
    }
    ...
    public class AssetFileDownloadCancelResult
    {
        ...
        {
            Filepath = CLIB.CLIB.ppf_AssetFileDownloadCancelResult_GetFilepath(o);
            Success = CLIB.CLIB.ppf_AssetFileDownloadCancelResult_GetSuccess(o);
            AssetId = CLIB.CLIB.ppf_AssetFileDownloadCancelResult_GetAssetId(o);
        }
    }
    ...
    public class AssetFileDownloadResult
    {
        ...
        {
            AssetId = CLIB.CLIB.ppf_AssetFileDownloadResult_GetAssetId(o);
            Filepath = CLIB.CLIB.ppf_AssetFileDownloadResult_GetFilepath(o);
        }
    }
    ...
    public class AssetFileDownloadUpdate
    {
        ...
        {
            AssetId = CLIB.CLIB.ppf_AssetFileDownloadUpdate_GetAssetId(o);
            BytesTotal = CLIB.CLIB.ppf_AssetFileDownloadUpdate_GetBytesTotal(o);
            BytesTransferred = CLIB.CLIB.ppf_AssetFileDownloadUpdate_GetBytesTransferred(o);
            CompleteStatus = CLIB.CLIB.ppf_AssetFileDownloadUpdate_GetCompleteStatus(o);
        }
    }
    ...
    public class AssetStatus
    {
        ...
        {
            AssetId = CLIB.CLIB.ppf_AssetStatus_GetAssetId(o);
            Filename = CLIB.CLIB.ppf_AssetStatus_GetFilename(o);
            Filepath = CLIB.CLIB.ppf_AssetStatus_GetFilepath(o);
            DownloadStatus = CLIB.CLIB.ppf_AssetStatus_GetDownloadStatus(o);
        }
    }
}