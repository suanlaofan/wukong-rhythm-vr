...
namespace ByteDance.PICO.Platform.Models
{
    ...
    public class SportDailySummary
    {
        ...
        {
            Id = CLIB.CLIB.ppf_SportDailySummary_GetId(o);
            Date = TimeUtil.MilliSecondsToDateTime(CLIB.CLIB.ppf_SportDailySummary_GetDate(o));
            DurationInSeconds = CLIB.CLIB.ppf_SportDailySummary_GetDurationInSeconds(o);
            PlanDurationInMinutes = CLIB.CLIB.ppf_SportDailySummary_GetPlanDurationInMinutes(o);
            Calorie = CLIB.CLIB.ppf_SportDailySummary_GetCalorie(o);
            PlanCalorie = CLIB.CLIB.ppf_SportDailySummary_GetPlanCalorie(o);
        }
    }
    ...
    public class SportDailySummaryList : MessageArray<SportDailySummary>
    {
        ...
        {
            var count = (int) CLIB.CLIB.ppf_SportDailySummaryArray_GetSize(a);
            this.Capacity = count;
            for (int i = 0; i < count; i++)
            {
                this.Add(new SportDailySummary(CLIB.CLIB.ppf_SportDailySummaryArray_GetElement(a, (UIntPtr) i)));
            }
        }
    }
    ...
    public class SportSummary
    {
        ...
        {
            DurationInSeconds = (int) CLIB.CLIB.ppf_SportSummary_GetDurationInSeconds(o);
            Calorie = CLIB.CLIB.ppf_SportSummary_GetCalorie(o);
            StartTime = TimeUtil.MilliSecondsToDateTime(CLIB.CLIB.ppf_SportSummary_GetStartTime(o));
            EndTime = TimeUtil.MilliSecondsToDateTime(CLIB.CLIB.ppf_SportSummary_GetEndTime(o));
        }
    }
    ...
    public class SportUserInfo
    {
        ...
        {
            Gender = CLIB.CLIB.ppf_SportUserInfo_GetGender(o);
            Birthday = TimeUtil.MilliSecondsToDateTime(CLIB.CLIB.ppf_SportUserInfo_GetBirthday(o));
            Stature = CLIB.CLIB.ppf_SportUserInfo_GetStature(o);
            Weight = CLIB.CLIB.ppf_SportUserInfo_GetWeight(o);
            SportLevel = CLIB.CLIB.ppf_SportUserInfo_GetSportLevel(o);
            DailyDurationInMinutes = CLIB.CLIB.ppf_SportUserInfo_GetDailyDurationInMinutes(o);
            DaysPerWeek = CLIB.CLIB.ppf_SportUserInfo_GetDaysPerWeek(o);
            SportTarget = CLIB.CLIB.ppf_SportUserInfo_GetSportTarget(o);
        }
    }
}