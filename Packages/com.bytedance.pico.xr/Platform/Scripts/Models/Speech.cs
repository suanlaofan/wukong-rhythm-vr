...
namespace ByteDance.PICO.Platform.Models
{
    ...
    public class AsrResult
    {
        ...
        {
            Text = CLIB.CLIB.ppf_AsrResult_GetText(o);
            IsFinalResult = CLIB.CLIB.ppf_AsrResult_GetIsFinalResult(o);
        }
    }
    ...
    public class SpeechError
    {
        ...
        {
            Message = CLIB.CLIB.ppf_SpeechError_GetMessage(o);
            Code = CLIB.CLIB.ppf_SpeechError_GetCode(o);
            SessionId = CLIB.CLIB.ppf_SpeechError_GetSessionId(o);
        }
    }
}