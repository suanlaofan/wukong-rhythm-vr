...
namespace ByteDance.PICO.Platform.Models
{
    ...
    public sealed class Packet : IDisposable
    {
        ...
        public Packet(IntPtr handler)
        {
            ...
            this.size = (ulong) CLIB.CLIB.ppf_Packet_GetSize(handler);
        }
        ...
        public ulong GetBytes(byte[] dest)
        {
            ...
            {
                Marshal.Copy(CLIB.CLIB.ppf_Packet_GetBytes(handler), dest, 0, (int) size);
                return size;
            }
            else
            {
        ...
        public string GetBytes()
        {
            if (size > 0)
            {
                ...
                Marshal.Copy(CLIB.CLIB.ppf_Packet_GetBytes(handler), bytes, 0, (int) size);
        ...
        {
            get { return CLIB.CLIB.ppf_Packet_GetSenderID(handler); }
        }
        ...
        public void Dispose()
        {
            CLIB.CLIB.ppf_Packet_Free(handler);
