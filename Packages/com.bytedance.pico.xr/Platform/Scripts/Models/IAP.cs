...
namespace ByteDance.PICO.Platform.Models
{
    ...
    public class Product
    {
        ...
        {
            Description = CLIB.CLIB.ppf_Product_GetDescription(o);
            DetailDescription = CLIB.CLIB.ppf_Product_GetDetailDescription(o);
            Price = CLIB.CLIB.ppf_Product_GetPrice(o);
            Currency = CLIB.CLIB.ppf_Product_GetCurrency(o);
            Name = CLIB.CLIB.ppf_Product_GetName(o);
            SKU = CLIB.CLIB.ppf_Product_GetSKU(o);
            Icon = CLIB.CLIB.ppf_Product_GetIcon(o);
            AddonsType = CLIB.CLIB.ppf_Product_GetAddonsType(o);
            PeriodType = CLIB.CLIB.ppf_Product_GetPeriodType(o);
            TrialPeriodUnit = CLIB.CLIB.ppf_Product_GetTrialPeriodUnit(o);
            TrialPeriodValue = CLIB.CLIB.ppf_Product_GetTrialPeriodValue(o);
            OuterId = CLIB.CLIB.ppf_Product_GetOuterId(o);
            OriginalPrice = CLIB.CLIB.ppf_Product_GetOriginalPrice(o);
            IsContinuous = CLIB.CLIB.ppf_Product_IsContinuous(o);
        }
    }
    ...
    public class ProductList : MessageArray<Product>
    {
        ...
        {
            var count = (int) CLIB.CLIB.ppf_ProductArray_GetSize(a);
            this.Capacity = count;
            for (int i = 0; i < count; i++)
            {
                this.Add(new Product(CLIB.CLIB.ppf_ProductArray_GetElement(a, (UIntPtr) i)));
            }

            NextPageParam = CLIB.CLIB.ppf_ProductArray_GetNextPageParam(a);
        }
    }
    ...
    public class Purchase
    {
        ...
        {
            ExpirationTime = TimeUtil.MilliSecondsToDateTime(CLIB.CLIB.ppf_Purchase_GetExpirationTime(o));
            GrantTime = TimeUtil.MilliSecondsToDateTime(CLIB.CLIB.ppf_Purchase_GetGrantTime(o));
            ID = CLIB.CLIB.ppf_Purchase_GetID(o);
            SKU = CLIB.CLIB.ppf_Purchase_GetSKU(o);
            Icon = CLIB.CLIB.ppf_Purchase_GetIcon(o);
            AddonsType = CLIB.CLIB.ppf_Purchase_GetAddonsType(o);
            OuterId = CLIB.CLIB.ppf_Purchase_GetOuterId(o);
            CurrentPeriodType = CLIB.CLIB.ppf_Purchase_GetCurrentPeriodType(o);
            NextPeriodType = CLIB.CLIB.ppf_Purchase_GetNextPeriodType(o);
            NextPayTime = TimeUtil.MilliSecondsToDateTime(CLIB.CLIB.ppf_Purchase_GetNextPayTime(o));
            DiscountType = CLIB.CLIB.ppf_Purchase_GetDiscountType(o);
            OrderComment = CLIB.CLIB.ppf_Purchase_GetOrderComment(o);
        }
    }
    ...
    public class PurchaseList : MessageArray<Purchase>
    {
        ...
        {
            var count = (int) CLIB.CLIB.ppf_PurchaseArray_GetSize(a);
            this.Capacity = count;
            for (int i = 0; i < count; i++)
            {
                this.Add(new Purchase(CLIB.CLIB.ppf_PurchaseArray_GetElement(a, (UIntPtr) i)));
            }

            NextPageParam = CLIB.CLIB.ppf_PurchaseArray_GetNextPageParam(a);
        }
    }
    ...
    public class SubscriptionStatus
    {
        ...
        {
            SKU = CLIB.CLIB.ppf_SubscriptionStatus_GetSKU(o);
            OuterId = CLIB.CLIB.ppf_SubscriptionStatus_GetOuterId(o);
            StartTime = TimeUtil.MilliSecondsToDateTime(CLIB.CLIB.ppf_SubscriptionStatus_GetStartTime(o));
            EndTime = TimeUtil.MilliSecondsToDateTime(CLIB.CLIB.ppf_SubscriptionStatus_GetEndTime(o));
            PeriodType = CLIB.CLIB.ppf_SubscriptionStatus_GetPeriodType(o);
            EntitlementStatus = CLIB.CLIB.ppf_SubscriptionStatus_GetEntitlementStatus(o);
            CancelReason = CLIB.CLIB.ppf_SubscriptionStatus_GetCancelReason(o);
            IsFreeTrial = CLIB.CLIB.ppf_SubscriptionStatus_GetIsFreeTrial(o);
            NextPeriod = CLIB.CLIB.ppf_SubscriptionStatus_GetNextPeriod(o);
        }
    }
}