...
namespace ByteDance.PICO.Platform.Models
{
    ...
    public class LaunchDetails
    {
        ...
        {
            DeeplinkMessage = CLIB.CLIB.ppf_LaunchDetails_GetDeeplinkMessage(o);
            DestinationApiName = CLIB.CLIB.ppf_LaunchDetails_GetDestinationApiName(o);
            LobbySessionID = CLIB.CLIB.ppf_LaunchDetails_GetLobbySessionID(o);
            MatchSessionID = CLIB.CLIB.ppf_LaunchDetails_GetMatchSessionID(o);
            Extra = CLIB.CLIB.ppf_LaunchDetails_GetExtra(o);
            RoomID = CLIB.CLIB.ppf_LaunchDetails_GetRoomID(o);
            ChallengeID = CLIB.CLIB.ppf_LaunchDetails_GetChallengeID(o);
            TrackingID = CLIB.CLIB.ppf_LaunchDetails_GetTrackingID(o);
            LaunchType = CLIB.CLIB.ppf_LaunchDetails_GetLaunchType(o);
        }
    }
    ...
    public class SystemInfo
    {
        ...
        {
            ROMVersion = CLIB.CLIB.ppf_SystemInfo_GetROMVersion(o);
            Locale = CLIB.CLIB.ppf_SystemInfo_GetLocale(o);
            ProductName = CLIB.CLIB.ppf_SystemInfo_GetProductName(o);
            IsCnDevice = CLIB.CLIB.ppf_SystemInfo_GetIsCnDevice(o);
            MatrixVersionName = CLIB.CLIB.ppf_SystemInfo_GetMatrixVersionName(o);
            MatrixVersionCode = CLIB.CLIB.ppf_SystemInfo_GetMatrixVersionCode(o);
        }
    }
    ...
    public class ApplicationVersion
    {
        ...
        {
            CurrentCode = CLIB.CLIB.ppf_ApplicationVersion_GetCurrentCode(o);
            CurrentName = CLIB.CLIB.ppf_ApplicationVersion_GetCurrentName(o);
            LatestCode = CLIB.CLIB.ppf_ApplicationVersion_GetLatestCode(o);
            LatestName = CLIB.CLIB.ppf_ApplicationVersion_GetLatestName(o);
        }
    }
}