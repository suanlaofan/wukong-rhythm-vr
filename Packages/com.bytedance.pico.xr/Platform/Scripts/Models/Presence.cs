...
namespace ByteDance.PICO.Platform.Models
{
    ...
    public class Destination
    {
        ...
        {
            ApiName = CLIB.CLIB.ppf_Destination_GetApiName(o);
            DeeplinkMessage = CLIB.CLIB.ppf_Destination_GetDeeplinkMessage(o);
            DisplayName = CLIB.CLIB.ppf_Destination_GetDisplayName(o);
        }
    }
    ...
    public class DestinationList : MessageArray<Destination>
    {
        ...
        {
            var count = (int) CLIB.CLIB.ppf_DestinationArray_GetSize(a);
            this.Capacity = count;
            for (int i = 0; i < count; i++)
            {
                this.Add(new Destination(CLIB.CLIB.ppf_DestinationArray_GetElement(a, (UIntPtr) i)));
            }

            NextPageParam = CLIB.CLIB.ppf_DestinationArray_GetNextPageParam(a);
        }
    }
    ...
    public class ApplicationInvite
    {
        ...
        {
            Destination = new Destination(CLIB.CLIB.ppf_ApplicationInvite_GetDestination(o));
            Recipient = new User(CLIB.CLIB.ppf_ApplicationInvite_GetRecipient(o));
            ID = CLIB.CLIB.ppf_ApplicationInvite_GetID(o);
            IsActive = CLIB.CLIB.ppf_ApplicationInvite_GetIsActive(o);
            LobbySessionId = CLIB.CLIB.ppf_ApplicationInvite_GetLobbySessionId(o);
            MatchSessionId = CLIB.CLIB.ppf_ApplicationInvite_GetMatchSessionId(o);
        }
    }
    ...
    public class ApplicationInviteList : MessageArray<ApplicationInvite>
    {
        ...
        {
            var count = (int) CLIB.CLIB.ppf_ApplicationInviteArray_GetSize(a);
            this.Capacity = count;
            for (int i = 0; i < count; i++)
            {
                this.Add(new ApplicationInvite(CLIB.CLIB.ppf_ApplicationInviteArray_GetElement(a, (UIntPtr) i)));
            }

            NextPageParam = CLIB.CLIB.ppf_ApplicationInviteArray_GetNextPageParam(a);
        }
    }
    ...
    public class SendInvitesResult
    {
        ...
        {
            Invites = new ApplicationInviteList(CLIB.CLIB.ppf_SendInvitesResult_GetInvites(o));
        }
    }
    ...
    public class PresenceJoinIntent
    {
        ...
        {
            DeeplinkMessage = CLIB.CLIB.ppf_PresenceJoinIntent_GetDeeplinkMessage(o);
            DestinationApiName = CLIB.CLIB.ppf_PresenceJoinIntent_GetDestinationApiName(o);
            LobbySessionId = CLIB.CLIB.ppf_PresenceJoinIntent_GetLobbySessionId(o);
            MatchSessionId = CLIB.CLIB.ppf_PresenceJoinIntent_GetMatchSessionId(o);
            Extra = CLIB.CLIB.ppf_PresenceJoinIntent_GetExtra(o);
        }
    }
}