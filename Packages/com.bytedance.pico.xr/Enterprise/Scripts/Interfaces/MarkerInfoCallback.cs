...
namespace ByteDance.PICO.Enterprise
{
    public class MarkerInfoCallback : AndroidJavaProxy
    {
        ...
        {
            Debug.Log("ToBService MarkerInfo Callback callback:" + var1);
        ...
        public List<MarkerInfo> JsonToMarkerInfos(string json)
        {
            ...
            {
                Debug.Log("TOB TestDemo---- MarkerInfo Callback callback:1");
                ...
                Debug.Log("TOB TestDemo---- MarkerInfo Callback callback:OriginHeight:"+OriginHeight );
