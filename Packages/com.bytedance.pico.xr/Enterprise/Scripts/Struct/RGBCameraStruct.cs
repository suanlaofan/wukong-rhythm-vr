...
namespace ByteDance.PICO.Enterprise
{
    ...
    {
        PXRCapture_RenderMode_LEFT, // Left camera data
        PXRCapture_RenderMode_RIGHT, // Right camera data
        PXRCapture_RenderMode_3D, // Left and right cameras stitched into one image
        PXRCapture_RenderMode_Interlace, // Left and right camera data sent sequentially, timestamps differ by 1
    }
