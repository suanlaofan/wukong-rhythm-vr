...
using Pose = ByteDance.PICO.Enterprise.Pose;
...
namespace ByteDance.PICO.Enterprise
{
    ...
    public class PXR_Enterprise
    {
        ...
        /// - `CUSTOMIZE_SETTINGS_TAB_APP_MANAGEMENT`: the App Management tab (only supported by PICO 4 Ultra with system version 5.13.0 or later)
        ...
        /// * `false`: failure
        /// </returns>
        [Obsolete("This interface is only supported on the PICO 4 Enterprise device and will not be supported in the future.")]
        ...
        /// <summary>Gets the current IPD (Interpupillary Distance) value from the device.</summary>
        /// <returns>
        /// The IPD value in millimeters (or meters, depending on system implementation).
        /// </returns>
        public static float GetIPD()
        {
            return PXR_EnterprisePlugin.UPxr_GetIPD();
        }
        ...
        /// <param name="intent">Specifies the service to start. The intent type is provided by PICO SDK.</param>
        /// <returns>
        ...
        /// <param name="intent">Specifies the broadcast to send. The intent type is provided by PICO SDK.</param>
        /// <returns>
        /// * `0`: success
        /// * `1`: failure
        /// </returns>               
        ...
        /// <summary>Sends broadcast.</summary>
        /// <param name="intent">Specifies the broadcast to send. The intent type is provided by Unity.</param>
        /// <returns>
        /// * `0`: success
        /// * `1`: failure
        /// </returns>  
        ...
        /// <param name="intent">Specifies the intent of `startActivity`. The intent type is provided by PICO SDK.</param>        
        /// <returns>
        /// * `0`: success
        /// * `1`: failure
        ...
        /// <summary>Starts an app on the virtual display.</summary>
        /// <param name="displayId">Specifies the ID of the virtual display.</param>
        /// <param name="intent">Specifies the intent of `startActivity`. The intent type is provided by Unity.</param>        
        /// <returns>
        /// * `0`: success
        /// * `1`: failure
        /// * `101`: the specified virtual display does not exist
        ...
        /// <summary>Sets the size of the boundary for large space quick mode.
        /// @note Only supported by 6 DoF devices, including PICO Neo3 Pro, PICO Neo3 Enterprise, and PICO 4 Enterprise.
        /// </summary>
        ...
        // KEY_MCTF: Controls whether to enable RGB image noise reduction. Due to performance limitations, it is recommended to enable only in <= 30fps scenarios.
        // Values: VALUE_TRUE or VALUE_FALSE, default VALUE_FALSE.
        // KEY_EIS: Controls whether to enable electronic image stabilization.
        // Values: VALUE_TRUE or VALUE_FALSE, default VALUE_FALSE.
        // KEY_MFNR: Controls whether to enable multi-frame composite photography. This flag must be enabled for capture functionality in the latest version.
        // Values: VALUE_TRUE or VALUE_FALSE, default VALUE_FALSE.
        ...
        public static int ET_Image_Init()
        {
            return PXR_EnterprisePlugin.Et_Init();
        }
        
        public static int ET_StartCapture(PXR_EnterprisePlugin.PxrEyeFrameCallBack callback)
        {
            return PXR_EnterprisePlugin.Et_StartCapture(callback);
        }
        
        public static int ET_SetConfig(int targetFps)
        {
            return PXR_EnterprisePlugin.Et_SetConfig(targetFps);
        }
        
        public static int ET_StopCapture()
        {
            return PXR_EnterprisePlugin.Et_StopCapture();
        }
        
        public static int ET_Release()
        {
            return PXR_EnterprisePlugin.Et_Release();
        }
    }
}